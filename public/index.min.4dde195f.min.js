!function (e, t) {
    ...
    function O(e, t, n) {
        ...
        return et.map(c, L, l), et.isFunction(l.opts.start) && l.opts.start.call(e, l), et.fx.timer(et.extend(u, {
            elem: e,
            anim: l,
            queue: l.opts.queue
    ...
    var it = function (e) {
        ...
        function p(e, n) {
            ...
            for (a = e, u = [], l = N.preFilter; a;) {
                ...
                for (s in N.filter)!(i = ht[s].exec(a)) || l[s] && !(i = l[s](i)) || (r = i.shift(), o.push({
                    value: r,
                    type: s,
                    matches: i
                }), a = a.slice(r.length));
        ...
        var T, C, N, k, E, D, j, S, A, L, q, H, O, F, P, M, R, W = "sizzle" + -new Date, $ = e.document, B = 0, I = 0, _ = n(), X = n(), z = n(), U = function (e, t) {
            return e === t && (A = !0), 0
                ...
                return -1
            }, nt = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", rt = "[\\x20\\t\\r\\n\\f]", it = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", ot = it.replace("w", "w#"), st = "\\[" + rt + "*(" + it + ")" + rt + "*(?:([*^$|!~]?=)" + rt + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + ot + ")|)|)" + rt + "*\\]", at = ":(" + it + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + st.replace(3, 8) + ")*)|.*)\\)|)", ut = new RegExp("^" + rt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + rt + "+$", "g"), lt = new RegExp("^" + rt + "*," + rt + "*"), ct = new RegExp("^" + rt + "*([>+~]|" + rt + ")" + rt + "*"), ft = new RegExp("=" + rt + "*([^\\]'\"]*?)" + rt + "*\\]", "g"), pt = new RegExp(at), dt = new RegExp("^" + ot + "$"), ht = {
            ID: new RegExp("^#(" + it + ")"),
            CLASS: new RegExp("^\\.(" + it + ")"),
    ...
    et.event = {
        ...
        add: function (e, t, n, r, i) {
            ...
            if (m)for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = et.guid++), (u = m.events) || (u = m.events = {}), (s = m.handle) || (s = m.handle = function (t) {
            ...
            }), t = (t || "").match(dt) || [""], l = t.length; l--;)a = St.exec(t[l]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d && (f = et.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = et.event.special[d] || {}, c = et.extend({
                type: d,
                origType: g,
                data: r,
                handler: n,
                ...
                namespace: h.join(".")
            }, o), (p = u[d]) || (p = u[d] = [], p.delegateCount = 0, f.setup && f.setup.call(e, r, h, s) !== !1 || e.addEventListener && e.addEventListener(d, s, !1)), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), i ? p.splice(p.delegateCount++, 0, c) : p.push(c), et.event.global[d] = !0)
        },
    ...
    !function () {
        ...
        a.style.backgroundClip = "content-box", a.cloneNode(!0).style.backgroundClip = "", J.clearCloneStyle = "content-box" === a.style.backgroundClip, s.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", s.appendChild(a), e.getComputedStyle && et.extend(J, {
    ...
    var Xt = /^(none|table(?!-c[ea]).+)/, zt = new RegExp("^(" + wt + ")(.*)$", "i"), Ut = new RegExp("^([+-])=(" + wt + ")", "i"), Vt = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    ...
    pn = bn.exec(dn.toLowerCase()) || [], et.extend({
        ...
        ajax: function (e, t) {
            ...
            var r, i, o, s, a, u, l, c, f = et.ajaxSetup({}, t), p = f.context || f, d = f.context && (p.nodeType || p.jquery) ? et(p) : et.event, h = et.Deferred(), g = et.Callbacks("once memory"), m = f.statusCode || {}, v = {}, y = {}, x = 0, b = "canceled", w = {
                readyState: 0,
    ...
    e.ActiveXObject && et(e).on("unload", function () {
        ...
        var t;
        return J.cors || Hn && !e.crossDomain ? {
            send: function (n, r) {
                var i, o = e.xhr(), s = ++An;
    ...
    et.fn.load = function (e, t, n) {
        ...
        return a >= 0 && (r = e.slice(a), e = e.slice(0, a)), et.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), s.length > 0 && et.ajax({
            url: e,
            type: i,
            dataType: "html",
            data: t
    ...
    et.offset = {
        ...
        offset: function (e) {
            ...
            if (o)return t = o.documentElement, et.contains(t, r) ? (typeof r.getBoundingClientRect !== kt && (i = r.getBoundingClientRect()), n = B(o), {
...
(function () {
    ...
    function g(e) {
        ...
        ao[B] = ao[W] = ao[K] = {
            ...
            toString: !0,
            valueOf: !0
        }, ao[H] = ao[V] = {constructor: !0, toString: !0, valueOf: !0}, ao[q] = ao[z] = ao[M] = {
            constructor: !0,
            toString: !0
        }, ao[U] = {constructor: !0}, function () {
        ...
        var fo = Xt || function (n) {
            ...
            '"': "&quot;",
            "'": "&#39;"
        }, bo = Sr(yo), mo = Ot("(" + po(bo).join("|") + ")", "g"), _o = Ot("[" + po(yo).join("") + "]", "g"), wo = gr(go), xo = gr(ho, {
            top: ho.top.replace(";", ";\nif (argsLength > 3 && typeof args[argsLength - 2] == 'function') {\n  var callback = baseCreateCallback(args[--argsLength - 1], args[argsLength--], 2);\n} else if (argsLength > 2 && typeof args[argsLength - 1] == 'function') {\n  callback = args[--argsLength];\n}"),
            loop: "result[index] = callback ? callback(result[index], iterable[index]) : iterable[index]"
        }), jo = gr(ho), ko = gr(go, vo, {useHas: !1}), Co = gr(go, vo);
        Dr(/x/) && (Dr = function (n) {
    ...
    var J = {leading: !1, maxWait: 0, trailing: !1}, Q = {
        ...
        "\u2028": "u2028",
        "\u2029": "u2029"
    }, nr = Y[typeof window] && window || this, rr = Y[typeof exports] && exports && !exports.nodeType && exports, er = Y[typeof module] && module && !module.nodeType && module, tr = er && er.exports === rr && rr, or = Y[typeof global] && global;
    ...
    e.rails = a = {
        ...
        handleRemote: function (n) {
            ...
            if (a.fire(n, "ajax:before")) {
                ...
                c = {
                    type: r || "GET", data: o, dataType: d, beforeSend: function (e, r) {
                ...
                }, u && (c.xhrFields = {withCredentials: u}), i && (c.url = i);
                var f = a.ajax(c);
    ...
    !function (t) {
        ...
        return p = "caret", e = function () {
            ...
            return e.prototype.setPos = function () {
                ...
                var e, o, n, r;
                if (l.getSelection && (n = this.range())) {
                    if (n.endOffset - 1 < 0)return null;
                    e = n.cloneRange(), e.setStart(n.endContainer, n.endOffset - 1), e.setEnd(n.endContainer, n.endOffset), r = e.getBoundingClientRect(), o = {
                        height: r.height,
                        left: r.left + r.width,
                        top: r.top
                    }, e.detach()
                } else a.selection && (o = this.getOldIEOffset());
                return o && (o.top += t(l).scrollTop(), o.left += t(l).scrollLeft()), o
    ...
    !function (t) {
        ...
        i = function () {
            ...
            return e.prototype.createContainer = function (e) {
                return 0 === (this.$el = t("#atwho-container", e)).length ? t(e.body).append(this.$el = t("<div id='atwho-container'></div>")) : void 0
                ...
                return this.$inputor.on("keyup.atwhoInner", function (t) {
                    ...
                    return function (e) {
                        var i;
                        return (i = t.controller()) ? i.view.hide(e, i.get_opt("display_timeout")) : void 0
                    }
            ...
            return e.prototype.uid = function () {
                ...
                try {
                    ...
                    return i = o, t.error("" + i + " Or maybe At.js doesn't have function " + n)
                }
            ...
            }, e.prototype.get_opt = function (t) {
                var e;
                try {
                ...
                return this.$inputor.is("[contentEditable]") ? this.cur_rect = null : void 0
            ...
            return e.prototype.init = function () {
                ...
                var e, i;
                return (e = this.$el.find(".cur")).length && (i = this.context.insert_content_for(e), this.context.insert(this.context.callbacks("before_insert").call(this.context, i, e), e), this.context.trigger("inserted", [e, t]), this.hide(t)), this.context.get_opt("hide_without_suffix") ? this.stop_showing = !0 : void 0
                ...
                var t;
                return this.stop_showing ? (this.stop_showing = !1, void 0) : (this.context.mark_range(), this.visible() || (this.$el.show(), this.context.trigger("shown")), (t = this.context.rect()) ? this.reposition(t) : void 0)
                ...
                for (this.$el.find("ul").empty(), n = this.$el.find("ul"), s = this.context.get_opt("tpl"), a = 0, h = e.length; h > a; a++)r = e[a], r = t.extend({}, r, {"atwho-at": this.context.at}), o = this.context.callbacks("tpl_eval").call(this.context, s, r), i = t(this.context.callbacks("highlighter").call(this.context, o, this.context.query.text)), i.data("item-data", r), n.append(i);
            ...
            before_save: function (e) {
                ...
                for (o = [], n = 0, r = e.length; r > n; n++)i = e[n], t.isPlainObject(i) ? o.push(i) : o.push({name: i});
                return o
                ...
                var n, r, o, s;
                for (s = [], r = 0, o = e.length; o > r; r++)n = e[r], ~new String(n[i]).toLowerCase().indexOf(t.toLowerCase()) && s.push(n);
                return s
            }, remote_filter: null, sorter: function (t, e, i) {
                var n, r, o, s;
                if (!t)return e;
                for (s = [], r = 0, o = e.length; o > r; r++)n = e[r], n.atwho_order = new String(n[i]).toLowerCase().indexOf(t.toLowerCase()), n.atwho_order > -1 && s.push(n);
    ...
    return function r(e, t, n) {
        ...
        1: [function (e, r) {
            ...
            function g(e, r, t) {
                ...
                return n >= 55296 && 56319 >= n ? r >= t.length - 1 ? "�" : (n = t.charCodeAt(r + 1), 56320 > n || n > 57343 ? "�" : e) : 0 === r ? "�" : (n = t.charCodeAt(r - 1), 55552 > n || n > 56319 ? "�" : e)
            }
            ...
            var x = Object.prototype.hasOwnProperty, A = /\\([!"#$%&'()*+,\-.\/:;<=>?@[\\\]^_`{|}~])/g, w = /&([a-z#][a-z0-9]{1,31});/gi, q = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))/i, C = e("./entities"), E = /[&<>"]/, S = /[&<>"]/g, D = {
                "&": "&amp;",
                "<": "&lt;",
                ">": "&gt;",
                '"': "&quot;"
            }, M = /[\uD800-\uDFFF]/, L = /[\uD800-\uDFFF]/g, T = /[.?*+^$[\]\\(){}|-]/g, F = /[\x21-\x23\x25-\x2A\x2C-\x2F\x3A\x3B\x3F\x40\x5B-\x5D\x5F\x7B\x7D\xA1\xA7\xAB\xB6\xB7\xBB\xBF\u037E\u0387\u055A-\u055F\u0589\u058A\u05BE\u05C0\u05C3\u05C6\u05F3\u05F4\u0609\u060A\u060C\u060D\u061B\u061E\u061F\u066A-\u066D\u06D4\u0700-\u070D\u07F7-\u07F9\u0830-\u083E\u085E\u0964\u0965\u0970\u0AF0\u0DF4\u0E4F\u0E5A\u0E5B\u0F04-\u0F12\u0F14\u0F3A-\u0F3D\u0F85\u0FD0-\u0FD4\u0FD9\u0FDA\u104A-\u104F\u10FB\u1360-\u1368\u1400\u166D\u166E\u169B\u169C\u16EB-\u16ED\u1735\u1736\u17D4-\u17D6\u17D8-\u17DA\u1800-\u180A\u1944\u1945\u1A1E\u1A1F\u1AA0-\u1AA6\u1AA8-\u1AAD\u1B5A-\u1B60\u1BFC-\u1BFF\u1C3B-\u1C3F\u1C7E\u1C7F\u1CC0-\u1CC7\u1CD3\u2010-\u2027\u2030-\u2043\u2045-\u2051\u2053-\u205E\u207D\u207E\u208D\u208E\u2308-\u230B\u2329\u232A\u2768-\u2775\u27C5\u27C6\u27E6-\u27EF\u2983-\u2998\u29D8-\u29DB\u29FC\u29FD\u2CF9-\u2CFC\u2CFE\u2CFF\u2D70\u2E00-\u2E2E\u2E30-\u2E42\u3001-\u3003\u3008-\u3011\u3014-\u301F\u3030\u303D\u30A0\u30FB\uA4FE\uA4FF\uA60D-\uA60F\uA673\uA67E\uA6F2-\uA6F7\uA874-\uA877\uA8CE\uA8CF\uA8F8-\uA8FA\uA92E\uA92F\uA95F\uA9C1-\uA9CD\uA9DE\uA9DF\uAA5C-\uAA5F\uAADE\uAADF\uAAF0\uAAF1\uABEB\uFD3E\uFD3F\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE61\uFE63\uFE68\uFE6A\uFE6B\uFF01-\uFF03\uFF05-\uFF0A\uFF0C-\uFF0F\uFF1A\uFF1B\uFF1F\uFF20\uFF3B-\uFF3D\uFF3F\uFF5B\uFF5D\uFF5F-\uFF65]/;
            t.assign = o, t.isString = s, t.has = i, t.unescapeMd = l, t.isValidEntityCode = c, t.fromCodePoint = u, t.replaceEntities = h, t.escapeHtml = d, t.arrayReplaceAt = a, t.normalizeLink = b, t.isWhiteSpace = k, t.isMdAsciiPunct = _, t.isPunctChar = y, t.escapeRE = v
        ...
        }, {"./parse_link_destination": 8, "./parse_link_label": 9, "./parse_link_title": 10}], 7: [function (e, r) {
            "use strict";
            ...
            "use strict";
            var t = e("../common/utils").normalizeLink, n = e("../common/utils").unescapeMd;
            r.exports = function (e, r, s) {
                var i, o, a = 0, l = r, c = {ok: !1, pos: 0, lines: 0, str: ""};
                if (60 === e.charCodeAt(r)) {
                    for (r++; s > r;) {
                        if (i = e.charCodeAt(r), 10 === i)return c;
                        if (62 === i)return c.pos = r + 1, c.str = t(n(e.slice(l + 1, r))), c.ok = !0, c;
                        92 === i && s > r + 1 ? r += 2 : r++
                    }
                    return c
                }
                for (o = 0; s > r && (i = e.charCodeAt(r), 32 !== i) && !(32 > i || 127 === i);)if (92 === i && s > r + 1)r += 2; else {
                    if (40 === i && (o++, o > 1))break;
                    if (41 === i && (o--, 0 > o))break;
                    r++
                }
            ...
            r.exports = function (e, r, n) {
                ...
                for (r++, 40 === i && (i = 41); n > r;) {
                    if (s = e.charCodeAt(r), s === i)return l.pos = r + 1, l.lines = o, l.str = t(e.slice(a + 1, r)), l.ok = !0, l;
                    10 === s ? o++ : 92 === s && n > r + 1 && (r++, 10 === e.charCodeAt(r) && o++), r++
                }
                return l
            }
        }, {"../common/utils": 5}], 11: [function (e, r) {
            "use strict";
            function t(e, r) {
                return this instanceof t ? (r || n.isString(e) || (r = e || {}, e = "default"), this.inline = new l, this.block = new a, this.core = new o, this.renderer = new i, this.utils = n, this.helpers = s, this.options = {}, this.configure(e), r && this.set(r), void 0) : new t(e, r)
            }

            var n = e("./common/utils"), s = e("./helpers"), i = e("./renderer"), o = e("./parser_core"), a = e("./parser_block"), l = e("./parser_inline"), c = {
            ...
            t.prototype.set = function (e) {
                ...
                var r, t = this;
                if (n.isString(e) && (r = e, e = c[r], !e))throw new Error('Wrong `markdown-it` preset "' + r + '", check name');
            ...
            var n = e("./ruler"), s = [["code", e("./rules_block/code")], ["fence", e("./rules_block/fence"), ["paragraph", "reference", "blockquote", "list"]], ["blockquote", e("./rules_block/blockquote"), ["paragraph", "reference", "blockquote", "list"]], ["hr", e("./rules_block/hr"), ["paragraph", "reference", "blockquote", "list"]], ["list", e("./rules_block/list"), ["paragraph", "reference", "blockquote"]], ["reference", e("./rules_block/reference"), ["reference"]], ["heading", e("./rules_block/heading"), ["paragraph", "reference", "blockquote"]], ["lheading", e("./rules_block/lheading")], ["html_block", e("./rules_block/html_block"), ["paragraph", "reference", "blockquote"]], ["table", e("./rules_block/table"), ["paragraph", "reference"]], ["paragraph", e("./rules_block/paragraph")]];
            t.prototype.tokenize = function (e, r, t) {
                for (var n, s, i = this.ruler.getRules(""), o = i.length, a = r, l = !1, c = e.md.options.maxNesting; t > a && (e.line = a = e.skipEmptyLines(a), !(a >= t)) && !(e.tShift[a] < e.blkIndent);) {
                    if (e.level >= c) {
                        e.line = t;
                        break
                    }
                ...
                var s;
                return e ? (s = new this.State(e, r, t, n), this.tokenize(s, s.line, s.lineMax), void 0) : []
            ...
            var n = e("./ruler"), s = [["normalize", e("./rules_core/normalize")], ["block", e("./rules_core/block")], ["inline", e("./rules_core/inline")], ["replacements", e("./rules_core/replacements")], ["smartquotes", e("./rules_core/smartquotes")], ["linkify", e("./rules_core/linkify")]];
            ...
            function t(e) {
                ...
                return r = i(r), r.indexOf(":") >= 0 && a.indexOf(r.split(":")[0]) >= 0 ? !1 : !0
            }
            ...
            var s = e("./ruler"), i = e("./common/utils").replaceEntities, o = [["text", e("./rules_inline/text")], ["newline", e("./rules_inline/newline")], ["escape", e("./rules_inline/escape")], ["backticks", e("./rules_inline/backticks")], ["strikethrough", e("./rules_inline/strikethrough")], ["emphasis", e("./rules_inline/emphasis")], ["link", e("./rules_inline/link")], ["image", e("./rules_inline/image")], ["autolink", e("./rules_inline/autolink")], ["html_inline", e("./rules_inline/html_inline")], ["entity", e("./rules_inline/entity")]], a = ["vbscript", "javascript", "file"];
            n.prototype.skipToken = function (e) {
                var r, t, n = e.pos, s = this.ruler.getRules(""), i = s.length, o = e.md.options.maxNesting;
                if ((t = e.cacheGet(n)) > 0)return e.pos = t, void 0;
                if (e.level < o) {
                    for (r = 0; i > r; r++)if (s[r](e, !0))return e.cacheSet(n, e.pos), void 0;
                    e.pos++
                } else e.pos = e.max;
                e.cacheSet(n, e.pos)
            ...
            var n = e("./common/utils").assign, s = e("./common/utils").unescapeMd, i = e("./common/utils").replaceEntities, o = e("./common/utils").escapeHtml, a = {};
            a.blockquote_open = function () {
                ...
                var n, a = e[r], l = "", c = t.langPrefix, u = "";
                ...
                var t = e[r].title ? ' title="' + o(i(e[r].title)) + '"' : "", n = e[r].target ? ' target="' + o(e[r].target) + '"' : "";
                return '<a href="' + o(e[r].href) + '"' + t + n + ">"
            }, a.link_close = function () {
                return "</a>"
            }, a.image = function (e, r, t, n, s) {
                var a = ' src="' + o(e[r].src) + '"', l = e[r].title ? ' title="' + o(i(e[r].title)) + '"' : "", c = ' alt="' + s.renderInlineAsText(e[r].tokens, t, n) + '"', u = t.xhtmlOut ? " /" : "";
                return "<img" + a + c + l + u + ">"
                ...
                for (var n = "", s = this.rules, i = 0, o = e.length; o > i; i++)n += s[e[i].type](e, i, r, t, this);
                return n
            }, t.prototype.renderInlineAsText = function (e, r, t) {
                for (var n = "", s = this.rules, i = 0, o = e.length; o > i; i++)"text" === e[i].type ? n += s.text(e, i, r, t, this) : "image" === e[i].type && (n += this.renderInlineAsText(e[i].tokens, r, t));
                return n
            }, t.prototype.render = function (e, r, t) {
                var n, s, i = "", o = this.rules;
                for (n = 0, s = e.length; s > n; n++)i += "inline" === e[n].type ? this.renderInline(e[n].children, r, t) : o[e[n].type](e, n, r, t, this);
                return i
            }, r.exports = t
        }, {"./common/utils": 5}], 19: [function (e, r) {
            "use strict";
            function t() {
            ...
            r.exports = function (e, r, t, n) {
                ...
                if (n)return !0;
                for (32 === e.src.charCodeAt(g) && g++, l = e.blkIndent, e.blkIndent = 0, a = [e.bMarks[r]], e.bMarks[r] = g, g = m > g ? e.skipSpaces(g) : g, i = g >= m, o = [e.tShift[r]], e.tShift[r] = g - e.bMarks[r], p = e.md.block.ruler.getRules("blockquote"), s = r + 1; t > s && (g = e.bMarks[s] + e.tShift[s], m = e.eMarks[s], !(g >= m)); s++)if (62 !== e.src.charCodeAt(g++)) {
                    if (i)break;
                    for (d = !1, h = 0, f = p.length; f > h; h++)if (p[h](e, s, t, !0)) {
                        d = !0;
                        break
                    }
                    if (d)break;
                    a.push(e.bMarks[s]), o.push(e.tShift[s]), e.tShift[s] = -1337
                } else 32 === e.src.charCodeAt(g) && g++, a.push(e.bMarks[s]), e.bMarks[s] = g, g = m > g ? e.skipSpaces(g) : g, i = g >= m, o.push(e.tShift[s]), e.tShift[s] = g - e.bMarks[s];
            ...
            r.exports = function (e, r, t, n) {
                ...
                if (l = u, u = e.skipChars(u, s), i = u - l, 3 > i)return !1;
                if (o = e.src.slice(u, p).trim(), o.indexOf("`") >= 0)return !1;
                if (n)return !0;
                for (a = r; (a++, !(a >= t)) && (u = l = e.bMarks[a] + e.tShift[a], p = e.eMarks[a], !(p > u && e.tShift[a] < e.blkIndent));)if (e.src.charCodeAt(u) === s && !(e.tShift[a] - e.blkIndent >= 4 || (u = e.skipChars(u, s), i > u - l || (u = e.skipSpaces(u), p > u)))) {
                    c = !0;
                    break
                }
            ...
            r.exports = function (e, r, t, n) {
                ...
                for (i = 1, s = e.src.charCodeAt(++a); 35 === s && l > a && 6 >= i;)i++, s = e.src.charCodeAt(++a);
            ...
            var n = e("../common/html_blocks"), s = /^<([a-zA-Z]{1,15})[\s\/>]/, i = /^<\/([a-zA-Z]{1,15})[\s>]/;
        ...
        }, {"../common/html_blocks": 2}], 26: [function (e, r) {
            "use strict";
            r.exports = function (e, r, t) {
                var n, s, i, o = r + 1;
            ...
            function t(e, r) {
                var t, n, s;
                return n = e.bMarks[r] + e.tShift[r], s = e.eMarks[r], n >= s ? -1 : (t = e.src.charCodeAt(n++), 42 !== t && 45 !== t && 43 !== t ? -1 : s > n && 32 !== e.src.charCodeAt(n) ? -1 : n)
            }
            ...
            function s(e, r) {
                var t, n, s = e.level + 2;
                for (t = r + 2, n = e.tokens.length - 2; n > t; t++)e.tokens[t].level === s && "paragraph_open" === e.tokens[t].type && (e.tokens[t + 2].tight = !0, e.tokens[t].tight = !0, t += 2)
            }

            r.exports = function (e, r, i, o) {
                var a, l, c, u, p, h, f, d, g, m, b, v, k, y, _, x, A, w, q, C, E, S, D = !0;
                if ((d = n(e, r)) >= 0)k = !0; else {
                    if (!((d = t(e, r)) >= 0))return !1;
                    k = !1
                }
                ...
                for (_ = e.tokens.length, k ? (f = e.bMarks[r] + e.tShift[r], b = Number(e.src.substr(f, d - f - 1)), e.tokens.push({
                    ...
                    lines: A = [r, 0],
                    level: e.level++
                }), a = r, x = !1, q = e.md.block.ruler.getRules("list"); !(!(i > a) || (y = e.skipSpaces(d), g = e.eMarks[a], m = y >= g ? 1 : y - d, m > 4 && (m = 1), 1 > m && (m = 1), l = d - e.bMarks[a] + m, e.tokens.push({
                    type: "list_item_open",
                    lines: w = [r, 0],
                    level: e.level++
                    ...
                    for (S = !1, C = 0, E = q.length; E > C; C++)if (q[C](e, a, i, !0)) {
                        S = !0;
                        break
                    }
                    if (S)break;
                    if (k) {
                        if (d = n(e, a), 0 > d)break
                    } else if (d = t(e, a), 0 > d)break;
            ...
            r.exports = function (e, r) {
                ...
                if (t = e.lineMax, t > l && !e.isEmpty(l))for (a = e.md.block.ruler.getRules("paragraph"); t > l && !e.isEmpty(l); l++)if (!(e.tShift[l] - e.blkIndent > 3)) {
                    for (s = !1, i = 0, o = a.length; o > i; i++)if (a[i](e, l, t, !0)) {
                        s = !0;
                        break
                    }
                    if (s)break
            ...
            "use strict";
            var t = e("../helpers/parse_link_destination"), n = e("../helpers/parse_link_title"), s = e("../helpers/normalize_reference");
            r.exports = function (e, r, i, o) {
                var a, l, c, u, p, h, f, d, g, m, b, v, k, y, _, x = 0, A = e.bMarks[r] + e.tShift[r], w = e.eMarks[r], q = r + 1;
                if (A >= w)return !1;
                if (91 !== e.src.charCodeAt(A))return !1;
                if (u = e.lineMax, u > q && !e.isEmpty(q))for (y = e.md.block.ruler.getRules("references"); u > q && !e.isEmpty(q); q++)if (!(e.tShift[q] - e.blkIndent > 3)) {
                    for (k = !1, h = 0, f = y.length; f > h; h++)if (y[h](e, q, u, !0)) {
                        k = !0;
                        break
                    }
                    if (k)break
                ...
                if (0 > g || 58 !== v.charCodeAt(g + 1))return !1;
                for (A = g + 2; w > A; A++)if (a = v.charCodeAt(A), 10 === a)x++; else if (32 !== a)break;
                if (m = t(v, A, w), !m.ok)return !1;
                if (!e.md.inline.validateLink(m.str))return !1;
                for (p = m.str, A = m.pos, x += m.lines, l = A, c = x, b = A; w > A; A++)if (a = v.charCodeAt(A), 10 === a)x++; else if (32 !== a)break;
                for (m = n(v, A, w), w > A && b !== A && m.ok ? (_ = m.str, A = m.pos, x += m.lines) : (_ = "", A = l, x = c); w > A && 32 === v.charCodeAt(A);)A++;
            ...
            t.prototype.isEmpty = function (e) {
                ...
                for (a = new Array(r - e), s = 0; r > c; c++, s++)l = this.tShift[c], l > t && (l = t), 0 > l && (l = 0), i = this.bMarks[c] + l, o = r > c + 1 || n ? this.eMarks[c] + 1 : this.eMarks[c], a[s] = this.src.slice(i, o);
                return a.join("")
            }, r.exports = t
        }, {}], 31: [function (e, r) {
            "use strict";
            ...
            r.exports = function (e, r, n, s) {
                ...
                if (o = t(e, r + 1), !/^[-:| ]+$/.test(o))return !1;
                if (u = o.split("|"), 2 >= u)return !1;
                ...
                if (o = t(e, r).trim(), -1 === o.indexOf("|"))return !1;
                ...
                for (e.tokens.push({type: "tr_close", level: --e.level}), e.tokens.push({
                    ...
                    lines: d = [r + 2, 0],
                    level: e.level++
                }), c = r + 2; n > c && !(e.tShift[c] < e.blkIndent) && (o = t(e, c).trim(), -1 !== o.indexOf("|")); c++) {
            ...
            var i = e("autolinker"), o = e("../common/utils").arrayReplaceAt, a = /www|@|\:\/\//;
            r.exports = function (e) {
                var r, i, l, c, u, p, h, f, d, g, m, b, v, k = e.tokens, y = null;
                if (e.md.options.linkify)for (i = 0, l = k.length; l > i; i++)if ("inline" === k[i].type)for (c = k[i].children, m = 0, r = c.length - 1; r >= 0; r--)if (u = c[r], "link_close" !== u.type) {
                    if ("html_inline" === u.type && (t(u.content) && m > 0 && m--, n(u.content) && m++), !(m > 0) && "text" === u.type && a.test(u.content)) {
                        if (y || (y = s(), b = y.links, v = y.autolinker), p = u.content, b.length = 0, v.link(p), !b.length)continue;
                        ...
                        p.length && h.push({type: "text", content: p, level: g}), k[i].children = c = o(c, r, h)
                    }
                } else for (r--; c[r].level !== u.level && "link_open" !== c[r].type;)r--
            }
        }, {"../common/utils": 5, autolinker: 51}], 35: [function (e, r) {
            "use strict";
            var t = /[\n\t]/g, n = /\r[\n\u0085]|[\u2424\u2028\u0085]/g, s = /\u0000/g;
            r.exports = function (e) {
                var r, i, o;
                e.normalizeInput && (r = e.src.replace(n, "\n"), r = r.replace(s, "�"), r.indexOf("	") >= 0 && (i = 0, o = 0, r = r.replace(t, function (e, t) {
                    var n;
            ...
            var s = /['"]/, i = /['"]/g, o = /[-\s()\[\]]/, a = "’";
            r.exports = function (e) {
                var r, o, l, c, u, p, h, f, d, g, m, b, v, k, y, _, x;
                if (e.md.options.typographer)for (x = [], y = e.tokens.length - 1; y >= 0; y--)if ("inline" === e.tokens[y].type)for (_ = e.tokens[y].children, x.length = 0, r = 0; r < _.length; r++)if (o = _[r], "text" === o.type && !s.test(o.text)) {
                    for (h = _[r].level, v = x.length - 1; v >= 0 && !(x[v].level <= h); v--);
                    x.length = v + 1, l = o.content, u = 0, p = l.length;
                    e:for (; p > u && (i.lastIndex = u, c = i.exec(l));)if (f = !t(l, c.index - 1), u = c.index + 1, k = "'" === c[0], d = !t(l, u), d || f) {
                    ...
                    } else k && (o.content = n(o.content, c.index, a))
                }
            }
        }, {}], 38: [function (e, r) {
            "use strict";
            ...
            "use strict";
            var t = e("../common/url_schemas"), n = e("../common/utils").normalizeLink, s = /^<([a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)>/, i = /^<([a-zA-Z.\-]{1,25}):([^<>\x00-\x20]*)>/;
            r.exports = function (e, r) {
                var o, a, l, c, u, p = e.pos;
        ...
        }, {"../common/url_schemas": 4, "../common/utils": 5}], 40: [function (e, r) {
            "use strict";
            r.exports = function (e, r) {
                var t, n, s, i, o, a = e.pos, l = e.src.charCodeAt(a);
                if (96 !== l)return !1;
                for (t = a, a++, n = e.posMax; n > a && 96 === e.src.charCodeAt(a);)a++;
            ...
            function n(e, r) {
                var n, a, l, c, u, p, h, f = r, d = !0, g = !0, m = e.posMax, b = e.src.charCodeAt(r);
                for (n = r > 0 ? e.src.charCodeAt(r - 1) : -1; m > f && e.src.charCodeAt(f) === b;)f++;
            ...
            var s = e("../common/utils").isWhiteSpace, i = e("../common/utils").isPunctChar, o = e("../common/utils").isMdAsciiPunct;
            r.exports = function (e, r) {
                var t, s, i, o, a, l, c, u = e.posMax, p = e.pos, h = e.src.charCodeAt(p);
                ...
                for (e.posMax = e.pos, e.pos = p + t, s = t; s > 1; s -= 2)e.push({
                    type: "strong_open",
                    level: e.level++
                });
                for (s % 2 && e.push({
                    ...
                    type: "em_close",
                    level: --e.level
                }), s = t; s > 1; s -= 2)e.push({type: "strong_close", level: --e.level});
                return e.pos = e.posMax + t, e.posMax = u, !0
            }
        }, {"../common/utils": 5}], 42: [function (e, r) {
            "use strict";
            var t = e("../common/entities"), n = e("../common/utils").has, s = e("../common/utils").isValidEntityCode, i = e("../common/utils").fromCodePoint, o = /^&#((?:x[a-f0-9]{1,8}|[0-9]{1,8}));/i, a = /^&([a-z][a-z0-9]{1,31});/i;
            r.exports = function (e, r) {
                var l, c, u, p = e.pos, h = e.posMax;
                if (38 !== e.src.charCodeAt(p))return !1;
                if (h > p + 1)if (l = e.src.charCodeAt(p + 1), 35 === l) {
                    if (u = e.src.slice(p).match(o))return r || (c = "x" === u[1][0].toLowerCase() ? parseInt(u[1].slice(1), 16) : parseInt(u[1], 10), e.pending += s(c) ? i(c) : i(65533)), e.pos += u[0].length, !0
                } else if (u = e.src.slice(p).match(a), u && n(t, u[1]))return r || (e.pending += t[u[1]]), e.pos += u[0].length, !0;
                return r || (e.pending += "&"), e.pos++, !0
            }
        }, {"../common/entities": 1, "../common/utils": 5}], 43: [function (e, r) {
            "use strict";
            for (var t = [], n = 0; 256 > n; n++)t.push(0);
            "\\!\"#$%&'()*+,./:;<=>?@[]^_`{|}~-".split("").forEach(function (e) {
                ...
                if (s++, i > s) {
                    if (n = e.src.charCodeAt(s), 256 > n && 0 !== t[n])return r || (e.pending += e.src[s]), e.pos += 2, !0;
                    if (10 === n) {
                        for (r || e.push({
                            type: "hardbreak",
                            level: e.level
                        }), s++; i > s && 32 === e.src.charCodeAt(s);)s++;
                        return e.pos = s, !0
                    }
                }
                return r || (e.pending += "\\"), e.pos++, !0
            ...
            var n = e("../common/html_re").HTML_TAG_RE, s = /^<!--[\s\S]*?-->$/;
            r.exports = function (e, r) {
                var i, o, a, l, c = e.pos;
                return e.md.options.html ? (a = e.posMax, 60 !== e.src.charCodeAt(c) || c + 2 >= a ? !1 : (i = e.src.charCodeAt(c + 1), 33 === i || 63 === i || 47 === i || t(i) ? (o = e.src.slice(c).match(n)) ? (l = e.src.slice(c, c + o[0].length), s.test(l) && /(^>|^->|--|-$)/.test(l.slice(4, -3)) ? !1 : (r || e.push({
                    type: "html_inline",
                    content: l,
                    level: e.level
                }), e.pos += o[0].length, !0)) : !1 : !1)) : !1
            }
        }, {"../common/html_re": 3}], 45: [function (e, r) {
            "use strict";
            var t = e("../helpers/parse_link_label"), n = e("../helpers/parse_link_destination"), s = e("../helpers/parse_link_title"), i = e("../helpers/normalize_reference");
            r.exports = function (e, r) {
                var o, a, l, c, u, p, h, f, d, g, m, b = e.pos, v = e.posMax;
                if (33 !== e.src.charCodeAt(e.pos))return !1;
                if (91 !== e.src.charCodeAt(e.pos + 1))return !1;
                if (u = e.pos + 2, c = t(e, e.pos + 1, !1), 0 > c)return !1;
                if (p = c + 1, v > p && 40 === e.src.charCodeAt(p)) {
                    ...
                    if (f = s(e.src, p, e.posMax), v > p && m !== p && f.ok)for (d = f.str, p = f.pos; v > p && (o = e.src.charCodeAt(p), 32 === o || 10 === o); p++); else d = "";
                    ...
                    if (v > p && 91 === e.src.charCodeAt(p) ? (m = p + 1, p = t(e, p), p >= 0 ? l = e.src.slice(m, p++) : p = c + 1) : p = c + 1, l || (l = e.src.slice(u, c)), h = e.env.references[i(l)], !h)return e.pos = b, !1;
                    a = h.href, d = h.title
                }
                if (!r) {
                    e.pos = u, e.posMax = c;
                    var k = new e.md.inline.State(e.src.slice(u, c), e.md, e.env, g = []);
                    k.md.inline.tokenize(k), e.push({type: "image", src: a, title: d, tokens: g, level: e.level})
                }
            ...
            var t = e("../helpers/parse_link_label"), n = e("../helpers/parse_link_destination"), s = e("../helpers/parse_link_title"), i = e("../helpers/normalize_reference");
            r.exports = function (e, r) {
                var o, a, l, c, u, p, h, f, d, g = e.pos, m = e.posMax, b = e.pos;
                if (91 !== e.src.charCodeAt(e.pos))return !1;
                if (u = e.pos + 1, c = t(e, e.pos, !0), 0 > c)return !1;
                if (p = c + 1, m > p && 40 === e.src.charCodeAt(p)) {
                    ...
                    if (h = s(e.src, p, e.posMax), m > p && b !== p && h.ok)for (d = h.str, p = h.pos; m > p && (o = e.src.charCodeAt(p), 32 === o || 10 === o); p++); else d = "";
                    if (p >= m || 41 !== e.src.charCodeAt(p))return e.pos = g, !1;
                    p++
                } else {
                    if ("undefined" == typeof e.env.references)return !1;
                    for (; m > p && (o = e.src.charCodeAt(p), 32 === o || 10 === o); p++);
                    if (m > p && 91 === e.src.charCodeAt(p) ? (b = p + 1, p = t(e, p), p >= 0 ? l = e.src.slice(b, p++) : p = c + 1) : p = c + 1, l || (l = e.src.slice(u, c)), f = e.env.references[i(l)], !f)return e.pos = g, !1;
                    a = f.href, d = f.title
                }
            ...
            t.prototype.pushPending = function () {
                ...
                for (var t = this.cache.length; e >= t; t++)this.cache.push(0);
                this.cache[e] = r
            ...
            function t(e, r) {
                ...
                for (t = r > 0 ? e.src.charCodeAt(r - 1) : -1; l > i && e.src.charCodeAt(i) === c;)i++;
                return i >= l && (o = !1), s = i - r, n = l > i ? e.src.charCodeAt(i) : -1, (32 === n || 10 === n) && (o = !1), (32 === t || 10 === t) && (a = !1), {
                    can_open: o,
                    can_close: a,
                    delims: s
                }
            ...
            r.exports = function (e, r) {
                var n, s, i, o, a, l, c = e.posMax, u = e.pos, p = e.src.charCodeAt(u);
                if (126 !== p)return !1;
                if (r)return !1;
                if (l = t(e, u), n = l.delims, !l.can_open)return e.pos += n, e.pending += e.src.slice(u, e.pos), !0;
                if (a = Math.floor(n / 2), 0 >= a)return !1;
                for (e.pos = u + n; e.pos < c;)if (e.src.charCodeAt(e.pos) !== p)e.md.inline.skipToken(e); else {
            ...
            !function (r, s) {
                ...
                return e.prototype = {
                    ...
                    link: function (r) {
                        ...
                        return n.parse(r, {
                            processHtmlNode: function (e, r, t) {
                                ...
                                if (0 === i)for (var n = e.Util.splitAndCapture(r, s), a = 0, l = n.length; l > a; a++) {
                    ...
                    matchHasUnbalancedClosingParen: function (e) {
                        ...
                        if (")" === r) {
                            var t = e.match(/\(/g), n = e.match(/\)/g), s = t && t.length || 0, i = n && n.length || 0;
                            if (i > s)return !0
                        }
                        return !1
                    },
                    createMatchReturnVal: function (r, t) {
                        ...
                        var s = this.getTagBuilder(), i = s.build(r);
                        return i.toString()
                    }
                }, e.link = function (r, t) {
                    var n = new e(t);
                    ...
                    htmlRegex: function () {
                        var e = /[0-9a-zA-Z][0-9a-zA-Z:]*/, r = /[^\s\0"'>\/=\x01-\x1F\x7F]+/, t = /(?:".*?"|'.*?'|[^'"=<>`\s]+)/, n = r.source + "(?:\\s*=\\s*" + t.source + ")?";
...
!function () {
    ...
    t.prototype = {
        ...
        for (var o = 0, i = 0, n = 0, a = new Array(e.length), s = new Array(e.length), h = 0; h < e.length; h++) {
            ...
            o += u;
            var d = f.getErrorCorrectPolynomial(l), c = new r(a[h], d.getLength() - 1), p = c.mod(d);
...
$(document).ready(function () {
    ...
    var n = $("#backtotop"), o = $(window).height() - n.height() - 200;
    n.click(function () {
        return $("html,body").animate({scrollTop: 0}), !1
    }), $(window).scroll(function () {
        var t = $(window).scrollTop();
        t > 200 ? n.fadeIn() : n.fadeOut()
    }), t(), $(window).resize(t), $(".topic_content a,.reply_content a").attr("target", "_blank"), prettyPrint(), $(".submit_btn").click(function () {
        $(this).button("loading")
...
$(document).ready(function () {
    var e = $("#responsive-sidebar-trigger"), t = $("#sidebar-mask"), n = $("#sidebar"), o = $("#main"), a = $(window).width(), c = 0, i = 0, d = {
        x: 0,
        y: 0
    }, h = a / 3, r = function () {
        ...
        c = +t[0].pageX, i = +t[0].pageY, d.x = d.y = 0, document.body.addEventListener("touchmove", u, !1), document.body.addEventListener("touchend", g, !1)
    }, u = function (e) {
        var t = e.changedTouches;
        d.x = +t[0].pageX - c, d.y = +t[0].pageY - i, Math.abs(d.x) > Math.abs(d.y) && e.preventDefault()
    }, g = function (t) {
        var n = t.changedTouches, o = e.data("is-show");
        d.x = +n[0].pageX - c, !o && c > 3 * a / 4 && Math.abs(d.x) > h && e.trigger("click"), o && 1 * a / 4 > c && Math.abs(d.x) > h && e.trigger("click"), c = i = 0, d.x = d.y = 0, document.body.removeEventListener("touchmove", u, !1), document.body.removeEventListener("touchend", g, !1)
    };
