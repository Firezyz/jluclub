!function (e) {
    ...
    function r(e, r) {
        r = r || {};
        var n = document.createElement("a"), i = r.shortcut || w[e];
    ...
    function o(e) {
        var t = e.codemirror.getWrapperElement(), r = document, n = r.fullScreen || r.mozFullScreen || r.webkitFullScreen, i = function () {
    ...
    function l(e) {
        var t, r = e.codemirror, n = i(r), o = "**", l = "**", a = r.getCursor("start"), s = r.getCursor("end");
    ...
    function m(e) {
        var t = e.toolbar.preview, r = e.constructor.markdown, n = e.codemirror, i = n.getWrapperElement(), o = i.lastChild;
    ...
    function y(e) {
        var t = /[a-zA-Z0-9_\u0392-\u03c9]+|[\u4E00-\u9FFF\u3400-\u4dbf\uf900-\ufaff\u3040-\u309f\uac00-\ud7af]+/g, r = e.match(t), n = 0;
        if (null === r)return n;
    ...
    var x = function () {
        ...
        function e(r, n) {
            ...
            l.wrapper.CodeMirror = this, c(this), n.autofocus && !Fi && dt(this), this.state = {
                keyMaps: [],
                overlays: [],
                modeGen: 0,
                overwrite: !1,
            ...
            var s = n.value;
            "string" == typeof s && (s = new yo(n.value, n.mode)), ot(this, un)(this, s), ki && setTimeout(ei(ht, this, !0), 20), mt(this);
            var u;
            try {
                u = document.activeElement == l.input
            } catch (f) {
            }
            u || n.autofocus && !Fi ? setTimeout(ei(Wt, this), 20) : Dt(this), ot(this, function () {
        ...
        function r(t) {
            ...
            }), t.doc.frontier = t.doc.first, D(t, 100), t.state.modeGen++, t.curOp && st(t)
        }

        function n(e) {
            e.options.lineWrapping ? (e.display.wrapper.className += " CodeMirror-wrap", e.display.sizer.style.minWidth = "") : (e.display.wrapper.className = e.display.wrapper.className.replace(" CodeMirror-wrap", ""), f(e)), o(e), st(e), U(e), setTimeout(function () {
                d(e)
            }, 100)
        }

        function i(e) {
            var t = tt(e.display), r = e.options.lineWrapping, n = r && Math.max(5, e.display.scroller.clientWidth / rt(e.display) - 3);
            return function (i) {
        ...
        function l(e) {
            var t = fo[e.options.keyMap], r = t.style;
        ...
        function u(e, t) {
            ...
            for (var r, n = t.text.length, i = t; r = Ir(i);) {
                var o = r.find();
        ...
        function f(e) {
            ...
            t.maxLine = fn(r, r.first), t.maxLineLength = u(r, t.maxLine), t.maxLineChanged = !0, r.iter(function (e) {
                var n = u(r, e);
        ...
        function d(e) {
            var t = e.display, r = e.doc.height, n = r + F(t);
            ...
            l ? (t.scrollbarV.style.display = "block", t.scrollbarV.style.bottom = o ? ci(t.measure) + "px" : "0", t.scrollbarV.firstChild.style.height = i - t.scroller.clientHeight + t.scrollbarV.clientHeight + "px") : t.scrollbarV.style.display = "", o ? (t.scrollbarH.style.display = "block", t.scrollbarH.style.right = l ? ci(t.measure) + "px" : "0", t.scrollbarH.firstChild.style.width = t.scroller.scrollWidth - t.scroller.clientWidth + t.scrollbarH.clientWidth + "px") : t.scrollbarH.style.display = "", o && l ? (t.scrollbarFiller.style.display = "block", t.scrollbarFiller.style.height = t.scrollbarFiller.style.width = ci(t.measure) + "px") : t.scrollbarFiller.style.display = "", o && e.options.coverGutterNextToScrollbar && e.options.fixedGutter ? (t.gutterFiller.style.display = "block", t.gutterFiller.style.height = ci(t.measure) + "px", t.gutterFiller.style.width = t.gutters.offsetWidth + "px") : t.gutterFiller.style.display = "", Oi && 0 === ci(t.measure) && (t.scrollbarV.style.minWidth = t.scrollbarH.style.minHeight = Ei ? "18px" : "12px")
        }
        ...
        function m(e) {
            ...
            if (t.alignWidgets || t.gutters.firstChild && e.options.fixedGutter) {
                for (var r = y(t) - t.scroller.scrollLeft + e.doc.scrollLeft, n = t.gutters.offsetWidth, i = r + "px", o = t.lineDiv.firstChild; o; o = o.nextSibling)if (o.alignable)for (var l = 0, a = o.alignable; l < a.length; ++l)a[l].style.left = i;
        ...
        function g(e) {
            ...
            if (r.length != n.lineNumChars) {
                var i = n.measure.appendChild(ni("div", [ni("div", r)], "CodeMirror-linenumber CodeMirror-gutter-elt")), o = i.firstChild.offsetWidth, l = i.offsetWidth - o;
        ...
        function x(e, t, r, n) {
            ...
            if (!(!n && 0 == t.length && r.from > i.showingFrom && r.to < i.showingTo)) {
                ...
                var c = o.first + o.size, u = Math.max(r.from - e.options.viewportMargin, o.first), f = Math.min(c, r.to + e.options.viewportMargin);
                ...
                var h = [{from: Math.max(i.showingFrom, o.first), to: Math.min(i.showingTo, c)}];
                ...
                if (!n && v == f - u && u == i.showingFrom && f == i.showingTo)return w(e), void 0;
                h.sort(function (e, t) {
                ...
                .7 * (f - u) > v && (i.lineDiv.style.display = "none"), S(e, u, f, h, a), i.lineDiv.style.display = "", y && document.activeElement != y && y.offsetHeight && y.focus();
                var x = u != i.showingFrom || f != i.showingTo || i.lastSizeC != i.wrapper.clientHeight;
                return x && (i.lastSizeC = i.wrapper.clientHeight, D(e, 400)), i.showingFrom = u, i.showingTo = f, C(e), w(e), !0
            }
        }
            ...
            for (var r = 0, n = t.length || 0; n > r; ++r) {
                for (var i = t[r], o = [], l = i.diff || 0, a = 0, s = e.length; s > a; ++a) {
                    ...
                    i.to <= c.from && i.diff ? o.push({
                        ...
                        from: c.from,
                        to: i.from
                    }), i.to < c.to && o.push({from: i.to + l, to: c.to + l}))
                }
                e = o
            }
            return e
        ...
        function S(e, t, r, n, i) {
            function o(t) {
                var r = t.nextSibling;
                return Ti && Pi && e.display.currentWheelTarget == t ? (t.style.display = "none", t.lineObj = null) : t.parentNode.removeChild(t), r
            }

            var l = k(e), a = e.display, s = e.options.lineNumbers;
            n.length || Ti && e.display.currentWheelTarget || ii(a.lineDiv);
            var c = a.lineDiv, u = c.firstChild, f = n.shift(), h = t;
            for (e.doc.iter(t, r, function (t) {
                if (f && f.to == h && (f = n.shift()), Br(e.doc, t)) {
                    ...
                    s && h >= i && u.lineNumber && li(u.lineNumber, v(e.options, h)), u = u.nextSibling
                } else {
                    if (t.widgets)for (var g, y = 0, b = u; b && 20 > y; ++y, b = b.nextSibling)if (b.lineObj == t && /div/i.test(b.nodeName)) {
                        g = b;
                        break
                    }
                    var x = M(e, t, h, l, g);
                    if (x != g)c.insertBefore(x, u); else {
                        for (; u != g;)u = o(u);
                        u = u.nextSibling
                    }
                    x.lineObj = t
        ...
        function M(e, t, r, n, i) {
            var o, l = Qr(e, t), a = t.gutterMarkers, s = e.display;
            if (!(e.options.lineNumbers || a || t.bgClass || t.wrapClass || t.widgets))return l;
            if (i) {
                i.alignable = null;
                for (var c, u = !0, f = 0, h = null, d = i.firstChild; d; d = c)if (c = d.nextSibling, /\bCodeMirror-linewidget\b/.test(d.className)) {
            ...
            if (o || (o = ni("div", null, t.wrapClass, "position: relative"), o.appendChild(l)), t.bgClass && o.insertBefore(ni("div", null, t.bgClass + " CodeMirror-linebackground"), o.firstChild), e.options.lineNumbers || a) {
                ...
                if (e.options.fixedGutter && (o.alignable || (o.alignable = [])).push(g), !e.options.lineNumbers || a && a["CodeMirror-linenumbers"] || (o.lineNumber = g.appendChild(ni("div", v(e.options, r), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + n.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + s.lineNumInnerWidth + "px"))), a)for (var y = 0; y < e.options.gutters.length; ++y) {
                    var b = e.options.gutters[y], x = a.hasOwnProperty(b) && a[b];
                    x && g.appendChild(ni("div", [x], "CodeMirror-gutter-elt", "left: " + n.gutterLeft[b] + "px; width: " + n.gutterWidth[b] + "px"))
                }
            }
            if (Si && (o.style.zIndex = 2), t.widgets && o != i)for (var p = 0, C = t.widgets; p < C.length; ++p) {
                var m = C[p], w = ni("div", [m.node], "CodeMirror-linewidget");
                m.handleMouseEvents || (w.ignoreEvents = !0), T(m, w, o, n), m.above ? o.insertBefore(w, e.options.lineNumbers && 0 != t.height ? g : l) : o.appendChild(w), Rn(m, "redraw")
            }
            return o
        }
        ...
        function N(e) {
            var t = e.display, r = Ut(e.doc.sel.from, e.doc.sel.to);
            if (r || e.options.showCursorWhenSelecting ? A(e) : t.cursor.style.display = t.otherCursor.style.display = "none", r ? t.selectionDiv.style.display = "none" : H(e), e.options.moveInputWithCursor) {
                var n = Z(e, e.doc.sel.head, "div"), i = ai(t.wrapper), o = ai(t.lineDiv);
        ...
        function H(e) {
            function t(e, t, r, n) {
                0 > t && (t = 0), l.appendChild(ni("div", null, "CodeMirror-selected", "position: absolute; left: " + e + "px; top: " + t + "px; width: " + (null == r ? a - e : r) + "px; height: " + (n - t) + "px"))
            }
            ...
            function r(r, n, o) {
                ...
                return fi(yn(f), n || 0, null == o ? h : o, function (e, r, i) {
                    ...
                    null == n && 0 == e && (d = s), f.top - m.top > 3 && (t(d, m.top, null, m.bottom), d = s, m.bottom < f.top && t(d, m.bottom, null, f.top)), null == o && r == h && (p = a), (!c || m.top < c.top || m.top == c.top && m.left < c.left) && (c = m), (!u || f.bottom > u.bottom || f.bottom == u.bottom && f.right > u.right) && (u = f), s + 1 > d && (d = s), t(d, f.top, p - d, f.bottom)
                }), {start: c, end: u}
            }

            var n = e.display, i = e.doc, o = e.doc.sel, l = document.createDocumentFragment(), a = n.lineSpace.offsetWidth, s = P(e.display);
            if (o.from.line == o.to.line)r(o.from.line, o.from.ch, o.to.ch); else {
                var c = fn(i, o.from.line), u = fn(i, o.to.line), f = Pr(i, c) == Pr(i, u), h = r(o.from.line, o.from.ch, f ? c.text.length : null).end, d = r(o.to.line, f ? 0 : null, o.to.ch).start;
        ...
        function O(e) {
            ...
            if (t.frontier < t.first && (t.frontier = t.first), !(t.frontier >= e.display.showingTo)) {
                var r, n = +new Date + e.options.workTime, i = gr(t.mode, z(e, t.frontier)), o = [];
                t.iter(t.frontier, Math.min(t.first + t.size, e.display.showingTo + 500), function (l) {
                    ...
                    } else Zr(e, l, i), l.stateAfter = t.frontier % 5 == 0 ? gr(t.mode, i) : null;
        ...
        function E(e, t, r) {
            for (var n, i, o = e.doc, l = t, a = t - 100; l > a; --l) {
                ...
                var c = qn(s.text, null, e.options.tabSize);
        ...
        function B(e, t, r, n, i) {
            ...
            return i = l > r ? "left" : r > l ? "right" : i, "left" == i && a.leftSide ? a = a.leftSide : "right" == i && a.rightSide && (a = a.rightSide), {
        ...
        function V(e, t) {
            ...
            var n = _(e, t), i = e.display.measureLineCache, o = {
                text: t.text,
        ...
        function _(e, t) {
            ...
            var i = e.display, o = Qn(t.text.length), l = Qr(e, t, o, !0);
            if (ki && !Si && !e.options.lineWrapping && l.childNodes.length > 100) {
                for (var a = document.createDocumentFragment(), s = 10, c = l.childNodes.length, u = 0, f = Math.ceil(c / s); f > u; ++u) {
                    for (var h = ni("div", null, null, "display: inline-block"), d = 0; s > d && c; ++d)h.appendChild(l.firstChild), --c;
                    a.appendChild(h)
                }
                l.appendChild(a)
            }
            oi(i.measure, l);
            var p = ai(i.lineDiv), m = [], g = Qn(t.text.length), v = l.offsetHeight;
            ...
            for (var y, u = 0; u < o.length; ++u)if (y = o[u]) {
                ...
                x || (x = g[u] = r(ai(b))), y.measureRight && (x.right = ai(y.measureRight).left), y.leftSide && (x.leftSide = r(ai(y.leftSide)))
            }
        ...
        function K(e, t) {
            ...
            var l = Qr(e, t, null, !0), a = l.appendChild(ui(e.display.measure));
            return oi(e.display.measure, l), ai(a).right - ai(e.display.lineDiv).left
        }
        ...
        function X(e, t, r) {
            ...
            if ("page" == r)n -= q(), i -= $(); else if ("local" == r || !r) {
        ...
        function Y(e, t, r, n, i) {
            return n || (n = fn(e.doc, t.line)), j(e, n, B(e, n, t.ch, null, i), r)
        }
        ...
        function Z(e, t, r, n, i) {
            ...
            function l(e, t) {
                ...
                return e == hi(r) && t && r.level < a[t - 1].level ? (r = a[--t], e = di(r) - (r.level % 2 ? 0 : 1), n = !0) : e == di(r) && t < a.length - 1 && r.level < a[t + 1].level && (r = a[++t], e = hi(r) - r.level % 2, n = !1), n && e == r.to && e > r.from ? o(e - 1) : o(e, n)
            }

            n = n || fn(e.doc, t.line), i || (i = V(e, n));
            var a = yn(n), s = t.ch;
            if (!a)return o(s);
            var c = bi(a, s), u = l(s, c);
            return null != zo && (u.other = l(s, zo)), u
        }
        ...
        function Q(e, t, r) {
            ...
            for (0 > t && (t = 0); ;) {
                var l = fn(n, i), a = et(e, l, i, t, r), s = Fr(l), c = s && s.find();
        ...
        function et(e, t, r, n, i) {
            ...
            var l = i - vn(e, t), a = !1, s = 2 * e.display.wrapper.clientWidth, c = V(e, t), u = yn(t), f = t.text.length, h = pi(t), d = mi(t), p = o(h), m = a, g = o(d), v = a;
        ...
        function it(e) {
            ...
            var c = t.maybeHiddenMarkers, u = t.maybeUnhiddenMarkers;
        ...
        function ft(e) {
            ...
            var l = !e.curOp;
            l && nt(e), i.shift = !1;
            for (var a = 0, s = Math.min(r.length, o.length); s > a && r.charCodeAt(a) == o.charCodeAt(a);)++a;
            var c = i.from, u = i.to;
            ...
            return Ft(e.doc, h, "end"), e.curOp.updateInput = f, Rn(e, "inputRead", e, h), o.length > 1e3 || o.indexOf("\n") > -1 ? t.value = e.display.prevInput = "" : e.display.prevInput = o, l && it(e), e.state.pasteIncoming = !1, !0
        }

        function ht(e, t) {
            var r, n, i = e.doc;
            if (Ut(i.sel.from, i.sel.to))t && (e.display.prevInput = e.display.input.value = "", ki && !Mi && (e.display.inputHasSelection = null)); else {
                e.display.prevInput = "", r = Oo && (i.sel.to.line - i.sel.from.line > 100 || (n = e.getSelection()).length > 1e3);
                var o = r ? "-" : n || e.getSelection();
                e.display.input.value = o, e.state.focused && Xn(e.display.input), ki && !Mi && (e.display.inputHasSelection = o)
            }
        ...
        function mt(e) {
            ...
            function r() {
                null == a && (a = setTimeout(function () {
                    a = null, l.cachedCharWidth = l.cachedTextHeight = Ao = null, U(e), at(e, ei(st, e))
                }, 100))
            }
            ...
            var l = e.display;
            Fn(l.scroller, "mousedown", ot(e, yt)), ki ? Fn(l.scroller, "dblclick", ot(e, function (t) {
                if (!Gn(e, t)) {
                    var r = vt(e, t);
            ...
            })) : Fn(l.scroller, "dblclick", function (t) {
                Gn(e, t) || Wn(t)
            }), Fn(l.lineSpace, "selectstart", function (e) {
                gt(l, e) || Wn(e)
            }), Ui || Fn(l.scroller, "contextmenu", function (t) {
                Ot(e, t)
            }), Fn(l.scroller, "scroll", function () {
                l.scroller.clientHeight && (wt(e, l.scroller.scrollTop), Lt(e, l.scroller.scrollLeft, !0), Bn(e, "scroll", e))
            }), Fn(l.scrollbarV, "scroll", function () {
                l.scroller.clientHeight && wt(e, l.scrollbarV.scrollTop)
            }), Fn(l.scrollbarH, "scroll", function () {
                l.scroller.clientHeight && Lt(e, l.scrollbarH.scrollLeft)
            }), Fn(l.scroller, "mousewheel", function (t) {
                kt(e, t)
            }), Fn(l.scroller, "DOMMouseScroll", function (t) {
                kt(e, t)
            }), Fn(l.scrollbarH, "mousedown", t), Fn(l.scrollbarV, "mousedown", t), Fn(l.wrapper, "scroll", function () {
                l.wrapper.scrollTop = l.wrapper.scrollLeft = 0
            });
            var a;
            Fn(window, "resize", r), setTimeout(n, 5e3), Fn(l.input, "keyup", ot(e, function (t) {
                Gn(e, t) || e.options.onKeyEvent && e.options.onKeyEvent(e, Hn(t)) || 16 == t.keyCode && (e.doc.sel.shift = !1)
            })), Fn(l.input, "input", ei(ut, e)), Fn(l.input, "keydown", ot(e, At)), Fn(l.input, "keypress", ot(e, Ht)), Fn(l.input, "focus", ei(Wt, e)), Fn(l.input, "blur", ei(Dt, e)), e.options.dragDrop && (Fn(l.scroller, "dragstart", function (t) {
                Ct(e, t)
            }), Fn(l.scroller, "dragenter", i), Fn(l.scroller, "dragover", i), Fn(l.scroller, "drop", ot(e, xt))), Fn(l.scroller, "paste", function (t) {
                gt(l, t) || (dt(e), ut(e))
            }), Fn(l.input, "paste", function () {
                e.state.pasteIncoming = !0, ut(e)
            }), Fn(l.input, "cut", o), Fn(l.input, "copy", o), Di && Fn(l.sizer, "mouseup", function () {
        ...
        function yt(e) {
            function t(e) {
                if (!Ut(v, e)) {
                    if (v = e, "single" == u)return Jt(i.doc, Xt(l, s), e), void 0;
            ...
            function r(e) {
                ...
                if (a)if (Ut(a, h)) {
                    ...
                    s && setTimeout(ot(i, function () {
                        b == n && (o.scroller.scrollTop += s, r(e))
                    }), 50)
                } else {
                    i.state.focused || Wt(i), h = a, t(a);
                    var c = p(o, l);
                    (a.line >= c.to || a.line < c.from) && setTimeout(ot(i, function () {
                        b == n && r(e)
                    }), 150)
                }
            }
            ...
            function n(e) {
                b = 1 / 0, Wn(e), dt(i), Pn(document, "mousemove", x), Pn(document, "mouseup", C)
            }

            if (!Gn(this, e)) {
                var i = this, o = i.display, l = i.doc, a = l.sel;
                ...
                if (!bt(i, e)) {
                    ...
                    switch (In(e)) {
                        case 3:
                            return Ui && Ot.call(i, i, e), void 0;
                        case 2:
                            return s && Jt(i.doc, s), setTimeout(ei(dt, i), 20), Wn(e), void 0
                    }
                    if (!s)return zn(e) == o.scroller && Wn(e), void 0;
                    i.state.focused || Wt(i);
                    var c = +new Date, u = "single";
                    if (_i && _i.time > c - 400 && Ut(_i.pos, s))u = "triple", Wn(e), setTimeout(ei(dt, i), 20), pr(i, s.line); else if (Vi && Vi.time > c - 400 && Ut(Vi.pos, s)) {
                        u = "double", _i = {time: c, pos: s}, Wn(e);
                        var f = dr(fn(l, s.line).text, s);
                        Jt(i.doc, f.from, f.to)
                    } else Vi = {time: c, pos: s};
                    var h = s;
                    if (i.options.dragDrop && No && !pt(i) && !Ut(a.from, a.to) && !qt(s, a.from) && !qt(a.to, s) && "single" == u) {
                        var d = ot(i, function (t) {
                            Ti && (o.scroller.draggable = !1), i.state.draggingText = !1, Pn(document, "mouseup", d), Pn(o.scroller, "drop", d), Math.abs(e.clientX - t.clientX) + Math.abs(e.clientY - t.clientY) < 10 && (Wn(t), Jt(i.doc, s), dt(i))
                        });
                        return Ti && (o.scroller.draggable = !0), i.state.draggingText = d, o.scroller.dragDrop && o.scroller.dragDrop(), Fn(document, "mouseup", d), Fn(o.scroller, "drop", d), void 0
                    }
                    Wn(e), "single" == u && Jt(i.doc, Xt(l, s));
                    var m = a.from, g = a.to, v = s, y = ai(o.wrapper), b = 0, x = ot(i, function (e) {
                        ki || In(e) ? r(e) : n(e)
                    }), C = ot(i, n);
                    Fn(document, "mousemove", x), Fn(document, "mouseup", C)
                }
            }
        }
        ...
        function bt(e, t) {
            ...
            for (var l = 0; l < e.options.gutters.length; ++l) {
                ...
                if (a && ai(a).right >= n) {
                    var s = gn(e.doc, i), c = e.options.gutters[l];
        ...
        function xt(e) {
            ...
            if (!(Gn(t, e) || gt(t.display, e) || t.options.onDragEvent && t.options.onDragEvent(t, Hn(e)))) {
                ...
                if (r && !pt(t))if (n && n.length && window.FileReader && window.File)for (var i = n.length, o = Array(i), l = 0, a = function (e, n) {
                    var a = new FileReader;
                    a.onload = function () {
                        o[n] = a.result, ++l == i && (r = Xt(t.doc, r), Ft(t.doc, {
                            from: r,
                            to: r,
                            text: Wo(o.join("\n")),
                            origin: "paste"
                    ...
                    try {
                        ...
                        if (o) {
                            var c = t.doc.sel.from, u = t.doc.sel.to;
                            er(t.doc, r, r), t.state.draggingText && _t(t.doc, "", c, u, "paste"), t.replaceSelection(o, null, "paste"), dt(t), Wt(t)
                        }
                    } catch (e) {
                    }
                }
        ...
        function Ct(e, t) {
            if (ki && (!e.state.draggingText || +new Date - Xi < 100))return En(t), void 0;
        ...
        function kt(e, t) {
            ...
            if (r && o.scrollWidth > o.clientWidth || n && o.scrollHeight > o.clientHeight) {
                ...
                if (r && !Li && !Hi && null != Zi)return n && wt(e, Math.max(0, Math.min(o.scrollTop + n * Zi, o.scrollHeight - o.clientHeight))), Lt(e, Math.max(0, Math.min(o.scrollLeft + r * Zi, o.scrollWidth - o.clientWidth))), Wn(t), i.wheelStartX = null, void 0;
                if (n && null != Zi) {
                    var a = n * Zi, s = e.doc.scrollTop, c = s + i.wrapper.clientHeight;
                    0 > a ? s = Math.max(0, s + a - 50) : c = Math.min(e.doc.height, c + a + 50), b(e, [], {
                        top: s,
                        bottom: c
                    })
                }
                20 > Yi && (null == i.wheelStartX ? (i.wheelStartX = o.scrollLeft, i.wheelStartY = o.scrollTop, i.wheelDX = r, i.wheelDY = n, setTimeout(function () {
                    if (null != i.wheelStartX) {
                        ...
                        i.wheelStartX = i.wheelStartY = null, r && (Zi = (Zi * Yi + r) / (Yi + 1), ++Yi)
                    }
        ...
        function Tt(e, t) {
            ...
            if (!i)return !1;
            var a = Mt(e);
            return o = t.shiftKey ? br("Shift-" + i, a, function (t) {
                return St(e, t, !0)
            }) || br(i, a, function (t) {
                return ("string" == typeof t ? /^go[A-Z]/.test(t) : t.motion) ? St(e, t) : void 0
            }) : br(i, a, function (t) {
                return St(e, t)
            }), o && (Wn(t), W(e), Mi && (t.oldKeyCode = t.keyCode, t.keyCode = 0), Rn(e, "keyHandled", e, i, t)), o
        }
        ...
        function Nt(e, t, r) {
            ...
            return n && (Wn(t), W(e), Rn(e, "keyHandled", e, "'" + r + "'", t)), n
        }
        ...
        function Ht(e) {
            ...
            if (!(Gn(t, e) || t.options.onKeyEvent && t.options.onKeyEvent(t, Hn(e)))) {
                ...
                if (!(Hi && (!e.which || e.which < 10) || Di) || !Tt(t, e)) {
                    ...
                    }), 75), Nt(t, e, i) || (ki && !Mi && (t.display.inputHasSelection = null), ut(t))
                }
            }
        }
        ...
        function Dt(e) {
            e.state.focused && (Bn(e, "blur", e), e.state.focused = !1, e.display.wrapper.className = e.display.wrapper.className.replace(" CodeMirror-focused", "")), clearInterval(e.display.blinker), setTimeout(function () {
        ...
        function Ot(e, t) {
            ...
            function n() {
                if (i.inputDiv.style.position = "relative", i.input.style.cssText = s, Mi && (i.scrollbarV.scrollTop = i.scroller.scrollTop = a), ct(e), null != i.input.selectionStart) {
            ...
            if (!Gn(e, t, "contextmenu")) {
                ...
                if (!gt(i, t)) {
                    var l = vt(e, t), a = i.scroller.scrollTop;
                    if (l && !Hi) {
                        (Ut(o.from, o.to) || qt(l, o.from) || !qt(l, o.to)) && ot(e, er)(e.doc, l, l);
                        ...
                        if (i.inputDiv.style.position = "absolute", i.input.style.cssText = "position: fixed; width: 30px; height: 30px; top: " + (t.clientY - 5) + "px; left: " + (t.clientX - 5) + "px; z-index: 1000; background: white; outline: none;border-width: 0; outline: none; overflow: hidden; opacity: .05; -ms-opacity: .05; filter: alpha(opacity=5);", dt(e), ht(e, !0), Ut(o.from, o.to) && (i.input.value = i.prevInput = " "), ki && !Mi && r(), Ui) {
                            En(t);
                            var c = function () {
                                Pn(window, "mouseup", c), setTimeout(n, 20)
                            };
                            Fn(window, "mouseup", c)
        ...
        function zt(e, t, r) {
            if (r && "object" == typeof r)return {anchor: Et(e, t, r.anchor), head: Et(e, t, r.head)};
            ...
            var i = function (e) {
                ...
                return e.line == t.to.line && (i += n.ch - t.to.ch), Kt(r, i)
            };
        ...
        function It(e, t, r) {
            ...
            return r && (n.update = function (t, r, n, i) {
                t && (this.from = Xt(e, t)), r && (this.to = Xt(e, r)), n && (this.text = n), void 0 !== i && (this.origin = i)
            }), Bn(e, "beforeChange", e, n), e.cm && Bn(e.cm, "beforeChange", e.cm, n), n.canceled ? null : {
                from: n.from,
                to: n.to,
                text: n.text,
                origin: n.origin
        ...
        function Ft(e, t, r, n) {
            ...
            if (!(_n(e, "beforeChange") || e.cm && _n(e.cm, "beforeChange")) || (t = It(e, t, !0))) {
                ...
                if (i) {
                    for (var o = i.length - 1; o >= 1; --o)Pt(e, {from: i[o].from, to: i[o].to, text: [""]});
                    i.length && Pt(e, {from: i[0].from, to: i[0].to, text: t.text}, r)
                } else Pt(e, t, r)
            }
        }
        ...
        function Pt(e, t, r) {
            var n = zt(e, t, r);
            wn(e, t, n, e.cm ? e.cm.curOp.id : 0 / 0), Gt(e, t, n, Dr(e, t));
            var i = [];
            cn(e, function (e, r) {
                r || -1 != Yn(i, e.history) || (Nn(e.history, t), i.push(e.history)), Gt(e, t, null, Dr(e, t))
            })
        }
            ...
            if (!e.cm || !e.cm.state.suppressEdits) {
                ...
                if (n) {
                    ...
                    for (var o = _n(e, "beforeChange") || e.cm && _n(e.cm, "beforeChange"), l = n.changes.length - 1; l >= 0; --l) {
                        var a = n.changes[l];
                        if (a.origin = t, o && !It(e, a, !1))return ("undo" == t ? r.done : r.undone).length = 0, void 0;
                        i.changes.push(Cn(e, a));
                        var s = l ? zt(e, a, null) : {anchor: n.anchorBefore, head: n.headBefore};
                        Gt(e, a, s, Or(e, a));
                        var c = [];
                        cn(e, function (e, t) {
                            t || -1 != Yn(c, e.history) || (Nn(e.history, a), c.push(e.history)), Gt(e, a, null, Or(e, a))
                        })
                    }
                }
            }
        ...
        function Rt(e, t) {
            ...
            e.first += t, e.cm && st(e.cm, e.first, e.first, t), e.sel.head = r(e.sel.head), e.sel.anchor = r(e.sel.anchor), e.sel.from = r(e.sel.from), e.sel.to = r(e.sel.to)
        }
        ...
        function Gt(e, t, r, n) {
            ...
            if (!(t.from.line > e.lastLine())) {
                ...
                t.to.line > o && (t = {
                    ...
                    text: [t.text[0]],
                    origin: t.origin
                }), t.removed = hn(e, t.from, t.to), r || (r = zt(e, t, null)), e.cm ? Vt(e.cm, t, n, r) : ln(e, t, n, r)
            }
        }

        function Vt(e, t, r, n) {
            var o = e.doc, l = e.display, a = t.from, s = t.to, c = !1, f = a.line;
            e.options.lineWrapping || (f = mn(Pr(o, fn(o, a.line))), o.iter(f, s.line + 1, function (e) {
                return e == l.maxLine ? (c = !0, !0) : void 0
            })), qt(o.sel.head, t.from) || qt(t.to, o.sel.head) || (e.curOp.cursorActivity = !0), ln(o, t, r, n, i(e)), e.options.lineWrapping || (o.iter(f, a.line + t.text.length, function (e) {
                var t = u(o, e);
            ...
            if (st(e, a.line, s.line + 1, h), _n(e, "change")) {
                var d = {from: a, to: s, text: t.text, removed: t.removed, origin: t.origin};
        ...
        function _t(e, t, r, n, i) {
            ...
            "string" == typeof t && (t = Wo(t)), Ft(e, {from: r, to: n, text: t, origin: i}, null)
        }
        ...
        function Qt(e, t, r) {
            ...
            return Bn(e, "beforeSelectionChange", e, n), e.cm && Bn(e.cm, "beforeSelectionChange", e.cm, n), n.anchor = Xt(e, n.anchor), n.head = Xt(e, n.head), n
        }
        ...
        function er(e, t, r, n, i) {
            ...
            if (l.goalColumn = null, (i || !Ut(t, l.anchor)) && (t = rr(e, t, n, "push" != i)), (i || !Ut(r, l.head)) && (r = rr(e, r, n, "push" != i)), !Ut(l.anchor, t) || !Ut(l.head, r)) {
                l.anchor = t, l.head = r;
                var a = qt(r, t);
                l.from = a ? r : t, l.to = a ? t : r, e.cm && (e.cm.curOp.updateInput = e.cm.curOp.selectionChanged = e.cm.curOp.cursorActivity = !0), Rn(e, "cursorActivity", e)
            }
        }
        ...
        function rr(e, t, r, n) {
            ...
            e:for (; ;) {
                ...
                if (a.markedSpans)for (var s = 0; s < a.markedSpans.length; ++s) {
                    var c = a.markedSpans[s], u = c.marker;
        ...
        function nr(e) {
            ...
            if (e.state.focused) {
                var r = e.display, n = ai(r.sizer), i = null;
        ...
        function ir(e, t, r) {
            for (null == r && (r = 0); ;) {
                var n = !1, i = Z(e, t), o = lr(e, i.left, i.top - r, i.left, i.bottom + r), l = e.doc.scrollTop, a = e.doc.scrollLeft;
        ...
        function or(e, t, r, n, i) {
            var o = lr(e, t, r, n, i);
            null != o.scrollTop && wt(e, o.scrollTop), null != o.scrollLeft && Lt(e, o.scrollLeft)
        }

        function lr(e, t, r, n, i) {
            var o = e.display, l = tt(e.display);
            0 > r && (r = 0);
            var a = o.scroller.clientHeight - Lo, s = o.scroller.scrollTop, c = {}, u = e.doc.height + F(o), f = l > r, h = i > u - l;
            if (s > r)c.scrollTop = f ? 0 : r; else if (i > s + a) {
                var d = Math.min(r, (h ? u : i) - a);
                d != s && (c.scrollTop = d)
            }
            var p = o.scroller.clientWidth - Lo, m = o.scroller.scrollLeft;
            t += o.gutters.offsetWidth, n += o.gutters.offsetWidth;
            var g = o.gutters.offsetWidth, v = g + 10 > t;
            return m + g > t || v ? (v && (t = 0), c.scrollLeft = Math.max(0, t - 10 - g)) : n > p + m - 3 && (c.scrollLeft = n + 10 - p), c
        }
        ...
        function cr(e, t, r, n) {
            var i = e.doc;
            if (null == r && (r = "add"), "smart" == r)if (e.doc.mode.indent)var o = z(e, t); else r = "prev";
            var l, a = e.options.tabSize, s = fn(i, t), c = qn(s.text, null, a), u = s.text.match(/^\s*/)[0];
            if ("smart" == r && (l = e.doc.mode.indent(o, s.text.slice(u.length), s.text), l == ko)) {
                if (!n)return;
                r = "prev"
            }
            "prev" == r ? l = t > i.first ? qn(fn(i, t - 1).text, null, a) : 0 : "add" == r ? l = c + e.options.indentUnit : "subtract" == r ? l = c - e.options.indentUnit : "number" == typeof r && (l = c + r), l = Math.max(0, l);
            var f = "", h = 0;
            if (e.options.indentWithTabs)for (var d = Math.floor(l / a); d; --d)h += a, f += "	";
            l > h && (f += $n(l - h)), f != u && _t(e.doc, f, Kt(t, 0), Kt(t, u.length), "+input"), s.stateAfter = null
        }

        function ur(e, t, r) {
            var n = t, i = t, o = e.doc;
            return "number" == typeof t ? i = fn(o, jt(o, t)) : n = mn(t), null == n ? null : r(i, n) ? (st(e, n, n + 1), i) : null
        }
        ...
        function fr(e, t, r, n, i) {
            ...
            var a = t.line, s = t.ch, c = r, u = fn(e, a), f = !0;
            if ("char" == n)l(); else if ("column" == n)l(!0); else if ("word" == n || "group" == n)for (var h = null, d = "group" == n, p = !0; !(0 > r) || l(!p); p = !1) {
        ...
        function dr(e, t) {
            ...
            return {from: Kt(t.line, r), to: Kt(t.line, n)}
        }
        ...
        function kr(e, t, r, n, i) {
            ...
            n && Jn(n, o), o.replacedWith && (o.collapsed = !0, o.replacedWith = ni("span", [o.replacedWith], "CodeMirror-widget"), n.handleMouseEvents || (o.replacedWith.ignoreEvents = !0)), o.collapsed && ($i = !0), o.addToHistory && wn(e, {
                from: t,
                to: r,
                origin: "markText"
            }, {head: e.sel.head, anchor: e.sel.anchor}, 0 / 0);
            var l, a, s, c = t.line, u = 0, f = e.cm;
            if (e.iter(c, r.line + 1, function (n) {
                    ...
                    u += n.text.length, c == t.line && (i.from = t.ch, u -= t.ch), c == r.line && (i.to = r.ch, u -= n.text.length - r.ch), o.collapsed && (c == r.line && (a = zr(n, r.ch)), c == t.line ? l = zr(n, t.ch) : pn(n, 0)), Ar(n, i), ++c
                }), o.collapsed && e.iter(t.line, r.line + 1, function (t) {
                    Br(e, t) && pn(t, 0)
                }), o.clearOnEnter && Fn(o, "beforeCursorEnter", function () {
                    o.clear()
            ...
            return f && (s && (f.curOp.updateMaxLine = !0), (o.className || o.title || o.startStyle || o.endStyle || o.collapsed) && st(f, t.line, r.line + 1), o.atomic && tr(f)), o
        }

        function Sr(e, t) {
            this.markers = e, this.primary = t;
            for (var r = 0, n = this; r < e.length; ++r)e[r].parent = this, Fn(e[r], "clear", function () {
                n.clear()
            })
        }
        ...
        function Mr(e, t, r, n, i) {
            n = Jn(n), n.shared = !1;
            var o = [kr(e, t, r, n, i)], l = o[0], a = n.replacedWith;
            return cn(e, function (e) {
                a && (n.replacedWith = a.cloneNode(!0)), o.push(kr(e, Xt(e, t), Xt(e, r), n, i));
        ...
        function Hr(e, t, r) {
            if (e)for (var n, i = 0; i < e.length; ++i) {
                ...
                if (a || "bookmark" == l.type && o.from == t && (!r || !o.marker.insertLeft)) {
                    ...
                    (n || (n = [])).push({from: o.from, to: s ? null : o.to, marker: l})
                }
            }
            return n
        }
        ...
        function Wr(e, t, r) {
            if (e)for (var n, i = 0; i < e.length; ++i) {
                ...
                if (a || "bookmark" == l.type && o.from == t && (!r || o.marker.insertLeft)) {
                    ...
                    (n || (n = [])).push({from: s ? null : o.from - t, to: null == o.to ? null : o.to - t, marker: l})
                }
            }
            return n
        }
        ...
        function Dr(e, t) {
            var r = Zt(e, t.from.line) && fn(e, t.from.line).markedSpans, n = Zt(e, t.to.line) && fn(e, t.to.line).markedSpans;
            if (!r && !n)return null;
            var i = t.from.ch, o = t.to.ch, l = Ut(t.from, t.to), a = Hr(r, i, l), s = Wr(n, o, l), c = 1 == t.text.length, u = jn(t.text).length + (c ? i : 0);
        ...
        function Er(e, t, r) {
            ...
            if (e.iter(t.line, r.line + 1, function (e) {
                    if (e.markedSpans)for (var t = 0; t < e.markedSpans.length; ++t) {
                        ...
                        !r.readOnly || n && -1 != Yn(n, r) || (n || (n = [])).push(r)
                    }
                }), !n)return null;
            for (var i = [{
                from: t,
                ...
                if (!qt(c.to, a.from) && !qt(a.to, c.from)) {
                    var u = [s, 1];
                    (qt(c.from, a.from) || !l.inclusiveLeft && Ut(c.from, a.from)) && u.push({
                        from: c.from,
                        to: a.from
        ...
        function Rr(e, t, r) {
            if (null == r.to) {
                var n = r.marker.find().to, i = fn(e, n.line);
        ...
        function Ur(e, t, r, n) {
            var i = new ho(e, r, n);
            return i.noHScroll && (e.display.alignWidgets = !0), ur(e, t, function (t) {
                ...
                if (null == i.insertAt ? r.push(i) : r.splice(Math.min(r.length - 1, Math.max(0, i.insertAt)), 0, i), i.line = t, !Br(e.doc, t) || i.showIfHidden) {
                    ...
                    pn(t, t.height + Kr(i)), n && sr(e, 0, i.height)
                }
                return !0
            }), i
        }
        ...
        function qr(e, t, r, n) {
            e.text = t, e.stateAfter && (e.stateAfter = null), e.styles && (e.styles = null), null != e.order && (e.order = null), Gr(e), Vr(e, r);
            var i = n ? n(e) : 1;
            i != e.height && pn(e, i)
        }
        ...
        function jr(e, t, r, n, i) {
            ...
            var l, a = 0, s = null, c = new wr(t, e.options.tabSize);
        ...
        function Xr(e, t, r) {
            ...
            jr(e, t.text, e.doc.mode, r, function (e, t) {
                n.push(e, t)
            });
            for (var i = 0; i < e.state.overlays.length; ++i) {
                var o = e.state.overlays[i], l = 1, a = 0;
                jr(e, t.text, o.mode, !0, function (e, t) {
                    for (var r = l; e > a;) {
                        var i = n[l];
        ...
        function Yr(e, t) {
            return t.styles && t.styles[0] == e.state.modeGen || (t.styles = Xr(e, t, t.stateAfter = z(e, mn(t)))), t.styles
        }

        function Zr(e, t, r) {
            var n = e.doc.mode, i = new wr(t.text, e.options.tabSize);
        ...
        function Qr(e, t, r, n) {
            for (var i, o = t, l = !0; i = Ir(o);)o = fn(e.doc, i.find().from.line);
            var a = {pre: ni("pre"), col: 0, pos: 0, measure: null, measuredSomething: !1, cm: e, copyWidgets: n};
            ...
            !r || a.measuredSomething || r[0] || (r[0] = a.pre.appendChild(l ? ni("span", " ") : ui(e.display.measure))), a.pre.firstChild || Br(e.doc, t) || a.pre.appendChild(document.createTextNode(" "));
            var c;
            if (r && ki && (c = yn(o))) {
                var u = c.length - 1;
                c[u].from == c[u].to && --u;
            ...
            return Bn(e, "renderLine", e, t, a.pre), a.pre
        }
        ...
        function en(e, t, r, n, i, o) {
            if (t) {
                if (go.test(t))for (var l = document.createDocumentFragment(), a = 0; ;) {
                    go.lastIndex = a;
                    var s = go.exec(t), c = s ? s.index - a : t.length - a;
                    if (c && (l.appendChild(document.createTextNode(t.slice(a, a + c))), e.col += c), !s)break;
                    if (a += c + 1, "	" == s[0]) {
                        var u = e.cm.options.tabSize, f = u - e.col % u;
                        l.appendChild(ni("span", $n(f), "cm-tab")), e.col += f
                    } else {
        ...
        function tn(e, t, r, n, i) {
            for (var o = e.cm.options.lineWrapping, l = 0; l < t.length; ++l) {
                var a = t.charAt(l), s = 0 == l;
                a >= "�" && "�" > a && l < t.length - 1 ? (a = t.slice(l, l + 2), ++l) : l && o && si(t, l) && e.pre.appendChild(ni("wbr"));
                var c = e.measure[e.pos], u = e.measure[e.pos] = en(e, a, r, s && n, l == t.length - 1 && i);
                c && (u.leftSide = c.leftSide || c), ki && o && " " == a && l && !/\s/.test(t.charAt(l - 1)) && l < t.length - 1 && !/\s/.test(t.charAt(l + 1)) && (u.style.whiteSpace = "normal"), e.pos += a.length
            }
        ...
        function on(e, t, r) {
            ...
            if (n)for (var l, a, s, c, u, f, h = i.length, d = 0, p = 1, m = "", g = 0; ;) {
                if (g == d) {
        ...
        function ln(e, t, r, n, i) {
            ...
            var a = t.from, s = t.to, c = t.text, u = fn(e, a.line), f = fn(e, s.line), h = jn(c), d = o(c.length - 1), p = s.line - a.line;
            if (0 == a.ch && 0 == s.ch && "" == h) {
                for (var m = 0, g = c.length - 1, v = []; g > m; ++m)v.push(new po(c[m], o(m), i));
                l(f, f.text, d), p && e.remove(a.line, p), v.length && e.insert(a.line, v)
            } else if (u == f)if (1 == c.length)l(u, u.text.slice(0, a.ch) + h + u.text.slice(s.ch), d); else {
                for (var v = [], m = 1, g = c.length - 1; g > m; ++m)v.push(new po(c[m], o(m), i));
                v.push(new po(h + u.text.slice(s.ch), d, i)), l(u, u.text.slice(0, a.ch) + c[0], o(0)), e.insert(a.line + 1, v)
            } else if (1 == c.length)l(u, u.text.slice(0, a.ch) + c[0] + f.text.slice(s.ch), o(0)), e.remove(a.line + 1, p); else {
                l(u, u.text.slice(0, a.ch) + c[0], o(0)), l(f, h + f.text.slice(s.ch), d);
                for (var m = 1, g = c.length - 1, v = []; g > m; ++m)v.push(new po(c[m], o(m), i));
        ...
        function un(e, t) {
            ...
            e.doc = t, t.cm = e, o(e), r(e), e.options.lineWrapping || f(e), e.options.mode = t.modeOption, st(e)
        }
        ...
        function mn(e) {
            ...
            for (var t = e.parent, r = Yn(t.lines, e), n = t.parent; n; t = n, n = n.parent)for (var i = 0; n.children[i] != t; ++i)r += n.children[i].chunkSize();
            return r + t.first
        }
        ...
        function yn(e) {
            var t = e.order;
            return null == t && (t = e.order = Io(e.text)), t
        }
        ...
        function Cn(e, t) {
            var r = {line: t.from.line, ch: t.from.ch}, n = {from: r, to: to(t), text: hn(e, t.from, t.to)};
            return xn(e, n, t.from.line, t.to.line + 1), cn(e, function (e) {
        ...
        function wn(e, t, r, n) {
            ...
            if (l && (i.lastOp == n || i.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && e.cm && i.lastTime > o - e.cm.options.historyEventDelay || "*" == t.origin.charAt(0)))) {
                var a = jn(l.changes);
                Ut(t.from, t.to) && Ut(t.from, a.to) ? a.to = to(t) : l.changes.push(Cn(e, t)), l.anchorAfter = r.anchor, l.headAfter = r.head
            } else for (l = {
                changes: [Cn(e, t)],
        ...
        function Tn(e, t, r, n) {
            for (var i = 0; i < e.length; ++i) {
                for (var o = e[i], l = !0, a = 0; a < o.changes.length; ++a) {
                    var s = o.changes[a];
                    if (o.copied || (s.from = $t(s.from), s.to = $t(s.to)), r < s.from.line)s.from.line += n, s.to.line += n; else if (t <= s.to.line) {
                        l = !1;
                        break
                    }
                }
                o.copied || (o.anchorBefore = $t(o.anchorBefore), o.headBefore = $t(o.headBefore), o.anchorAfter = $t(o.anchorAfter), o.readAfter = $t(o.headAfter), o.copied = !0), l ? (Mn(o.anchorBefore), Mn(o.headBefore), Mn(o.anchorAfter), Mn(o.headAfter)) : (e.splice(0, i + 1), i = 0)
            }
        }
        ...
        function In(e) {
            var t = e.which;
            return null == t && (1 & e.button ? t = 1 : 2 & e.button ? t = 3 : 4 & e.button && (t = 2)), Pi && e.ctrlKey && 1 == t && (t = 3), t
        }
        ...
        function Gn(e, t, r) {
            return Bn(e, r || t.type, e, t), On(t) || t.codemirrorIgnore
        }
        ...
        function Xn(e) {
            if (Ii)e.selectionStart = 0, e.selectionEnd = e.value.length; else try {
                e.select()
            } catch (t) {
            }
        }
        ...
        function bi(e, t) {
            for (var r, n = 0; n < e.length; ++n) {
                var i = e[n];
                if (i.from < t && i.to > t)return zo = null, n;
                if (i.from == t || i.to == t) {
        ...
        e.Pos = Kt, e.prototype = {
            constructor: e, focus: function () {
                ...
                this.state.overlays.push({mode: n, modeSpec: t, opaque: r && r.opaque}), this.state.modeGen++, st(this)
            }), removeOverlay: ot(null, function (e) {
                for (var t = this.state.overlays, r = 0; r < t.length; ++r) {
                    var n = t[r].modeSpec;
                    if (n == e || "string" == typeof e && n.name == e)return t.splice(r, 1), this.state.modeGen++, st(this), void 0
                }
            }), indentLine: ot(null, function (e, t, r) {
                "string" != typeof t && "number" != typeof t && (t = null == t ? this.options.smartIndent ? "smart" : "prev" : t ? "add" : "subtract"), Zt(this.doc, e) && cr(this, e, t, r)
                ...
                e = Xt(this.doc, e);
                var t = Yr(this, fn(this.doc, e.line)), r = 0, n = (t.length - 1) / 2, i = e.ch;
                if (0 == i)return t[2];
                for (; ;) {
                    var o = r + n >> 1;
                ...
                r.iter(function (r) {
                    r.gutterMarkers && r.gutterMarkers[e] && (r.gutterMarkers[e] = null, st(t, n, n + 1), ri(r.gutterMarkers) && (r.gutterMarkers = null)), ++n
                })
                ...
                t.style.top = l + "px", t.style.left = t.style.right = "", "right" == i ? (a = o.sizer.clientWidth - t.offsetWidth, t.style.right = "0px") : ("left" == i ? a = 0 : "middle" == i && (a = (o.sizer.clientWidth - t.offsetWidth) / 2), t.style.left = a + "px"), r && or(this, a, l, a + t.offsetWidth, l + t.offsetHeight)
            }, triggerOnKeyDown: ot(null, At), execCommand: function (e) {
                return uo[e](this)
            }, findPosH: function (e, t, r, n) {
                var i = 1;
                0 > t && (i = -1, t = -t);
                for (var o = 0, l = Xt(this.doc, e); t > o && (l = fr(this.doc, l, i, r, n), !l.hitSide); ++o);
                return l
            }, moveH: ot(null, function (e, t) {
                var r, n = this.doc.sel;
                r = n.shift || n.extend || Ut(n.from, n.to) ? fr(this.doc, n.head, e, t, this.options.rtlMoveVisually) : 0 > e ? n.from : n.to, Jt(this.doc, r, r, e)
            }), deleteH: ot(null, function (e, t) {
                var r = this.doc.sel;
                Ut(r.from, r.to) ? _t(this.doc, "", r.from, fr(this.doc, r.head, e, t, !1), "+delete") : _t(this.doc, "", r.from, r.to, "+delete"), this.curOp.userSelChange = !0
            }), findPosV: function (e, t, r, n) {
                var i = 1, o = n;
                0 > t && (i = -1, t = -t);
                for (var l = 0, a = Xt(this.doc, e); t > l; ++l) {
                    var s = Z(this, a, "div");
                ...
                var i = hr(this, n, e, t);
                "page" == t && sr(this, 0, Y(this, i, "div").top - n.top), Jt(this.doc, i, i, e), r.goalColumn = n.left
                ...
                var e = this.display.scroller, t = Lo;
                return {
                    left: e.scrollLeft,
                    top: e.scrollTop,
                ...
                "number" == typeof e && (e = Kt(e, 0)), t || (t = 0);
                var r = e;
                ...
                U(this), ar(this, this.doc.scrollLeft, this.doc.scrollTop), st(this)
            }), swapDoc: ot(null, function (e) {
                var t = this.doc;
                return t.cm = null, un(this, e), U(this), ht(this, !0), ar(this, e.scrollLeft, e.scrollTop), t
        ...
        mr("value", "", function (e, t) {
            ...
            r(e), U(e), st(e)
        }, !0), mr("electricChars", !0), mr("rtlMoveVisually", !Bi), mr("theme", "default", function (e) {
            a(e), s(e)
            ...
            h(e.options), s(e)
        }, !0), mr("firstLineNumber", 1, s, !0), mr("lineNumberFormatter", function (e) {
            return e
        }, s, !0), mr("showCursorWhenSelecting", !1, N, !0), mr("readOnly", !1, function (e, t) {
        ...
        e.registerHelper = function (t, r, n) {
            co.hasOwnProperty(t) || (co[t] = e[t] = {}), co[t][r] = n
        ...
        var uo = e.commands = {
            selectAll: function (e) {
                ...
                var t = e.getCursor(!0), r = e.getCursor(!1), n = !Ut(t, r);
        ...
        fo.basic = {
        ...
        }, fo["default"] = Pi ? fo.macDefault : fo.pcDefault, fo.emacsy = {
            "Ctrl-F": "goCharRight",
            "Ctrl-B": "goCharLeft",
            "Ctrl-P": "goLineUp",
            "Ctrl-N": "goLineDown",
        ...
        }, e.lookupKey = br, e.isModifierKey = xr, e.keyName = Cr, e.fromTextArea = function (t, r) {
            function n() {
                t.value = c.getValue()
            }
            ...
            if (t.form && (Fn(t.form, "submit", n), !r.leaveSubmitMethodAlone)) {
                var l = t.form, a = l.submit;
                try {
                    var s = l.submit = function () {
                        n(), l.submit = a, l.submit(), l.submit = s
                    }
                } catch (o) {
                }
            }
            ...
            return c.save = n, c.getTextArea = function () {
                return t
            }, c.toTextArea = function () {
                n(), t.parentNode.removeChild(c.getWrapperElement()), t.style.display = "", t.form && (Pn(t.form, "submit", n), "function" == typeof t.form.submit && (t.form.submit = a))
            }, c
        }, wr.prototype = {
            eol: function () {
        ...
        }, e.StringStream = wr, e.TextMarker = Lr, Kn(Lr), Lr.prototype.clear = function () {
            if (!this.explicitlyCleared) {
                ...
                for (var n = null, i = null, o = 0; o < this.lines.length; ++o) {
                    ...
                    null != a.to && (i = mn(l)), l.markedSpans = Nr(l.markedSpans, a), null != a.from ? n = mn(l) : this.collapsed && !Br(this.doc, l) && e && pn(l, tt(e.display))
                }
                if (e && this.collapsed && !e.options.lineWrapping)for (var o = 0; o < this.lines.length; ++o) {
                    var s = Pr(e.doc, this.lines[o]), c = u(e.doc, s);
                    c > e.display.maxLineLength && (e.display.maxLine = s, e.display.maxLineLength = c, e.display.maxLineChanged = !0)
                }
                null != n && e && st(e, n, i + 1), this.lines.length = 0, this.explicitlyCleared = !0, this.atomic && this.doc.cantEdit && (this.doc.cantEdit = !1, e && tr(e)), t && it(e)
            }
            ...
            for (var e, t, r = 0; r < this.lines.length; ++r) {
                ...
                if (null != i.from || null != i.to) {
                    var o = mn(n);
                    null != i.from && (e = Kt(o, i.from)), null != i.to && (t = Kt(o, i.to))
                }
            }
        ...
        }, e.SharedTextMarker = Sr, Kn(Sr), Sr.prototype.clear = function () {
            if (!this.explicitlyCleared) {
        ...
        Kn(ho), ho.prototype.clear = _r(function () {
            ...
            if (null != t && e) {
                ...
                pn(this.line, Math.max(0, this.line.height - Kr(this))), n && sr(this.cm, 0, -this.height), st(this.cm, t, t + 1)
            }
        ...
        var po = e.Line = function (e, t, r) {
            this.text = e, Vr(this, t), this.height = r ? r(this) : 1
        };
        Kn(po);
        var mo = {}, go = /[\t\u0000-\u0019\u00ad\u200b\u2028\u2029\uFEFF]/g;
        an.prototype = {
            chunkSize: function () {
                ...
                for (var r = e, n = e + t; n > r; ++r) {
                    var i = this.lines[r];
                    this.height -= i.height, $r(i), Rn(i, "delete")
                }
            ...
            chunkSize: function () {
                ...
                if (this.size - t < 25) {
                    var a = [];
                    this.collapse(a), this.children = [new an(a)], this.children[0].parent = this
                }
            }, collapse: function (e) {
                    ...
                    if (l >= e) {
                        if (o.insertInner(e, t, r), o.lines && o.lines.length > 50) {
                            for (; o.lines.length > 50;) {
                                var a = o.lines.splice(o.lines.length - 25, 25), s = new an(a);
        ...
        var vo = 0, yo = e.Doc = function (e, t, r) {
            ...
            null == r && (r = 0), sn.call(this, [new an([new po("", null)])]), this.first = r, this.scrollTop = this.scrollLeft = 0, this.cantEdit = !1, this.history = bn(), this.cleanGeneration = 1, this.frontier = r;
            var n = Kt(r, 0);
            this.sel = {
                from: n,
                to: n,
        ...
        yo.prototype = Zn(sn.prototype, {
            constructor: yo, iter: function (e, t, r) {
                ...
                var t = Kt(this.first, 0), r = this.first + this.size - 1;
                Ft(this, {from: t, to: Kt(r, fn(this, r).text.length), text: Wo(e), origin: "setValue"}, {
                    head: t,
                    anchor: t
                }, !0)
            }, replaceRange: function (e, t, r, n) {
                t = Xt(this, t), r = r ? Xt(this, r) : t, _t(this, e, t, r, n)
                ...
                return "number" == typeof e && (e = fn(this, e)), Pr(this, e)
            }, lineCount: function () {
                return this.size
            }, firstLine: function () {
                return this.first
                ...
                var t, r = this.sel;
                return t = null == e || "head" == e ? r.head : "anchor" == e ? r.anchor : "end" == e || e === !1 ? r.to : r.from, $t(t)
                ...
                Ft(this, {from: this.sel.from, to: this.sel.to, text: Wo(e), origin: r}, t || "around")
            }, undo: lt(function () {
                Bt(this, "undo")
            }), redo: lt(function () {
                Bt(this, "redo")
                ...
                return e = Xt(this, e), kr(this, e, e, r, "bookmark")
            }, findMarksAt: function (e) {
                e = Xt(this, e);
                var t = [], r = fn(this, e.line).markedSpans;
        ...
        Kn(yo), e.e_stop = En, e.e_preventDefault = Wn, e.e_stopPropagation = Dn;
        var Co, wo = 0;
        e.on = Fn, e.off = Pn, e.signal = Bn;
        var Lo = 30, ko = e.Pass = {
            toString: function () {
        ...
        var So = [""], Mo = /[\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/, To = /[\u0300-\u036F\u0483-\u0487\u0488-\u0489\u0591-\u05BD\u05BF\u05C1-\u05C2\u05C4-\u05C5\u05C7\u0610-\u061A\u064B-\u065F\u0670\u06D6-\u06DC\u06DF-\u06E4\u06E7-\u06E8\u06EA-\u06ED\uA66F\uA670-\uA672\uA674-\uA67D\uA69F\udc00-\udfff]/;
        ...
        var zo, Io = function () {
            ...
            return function (t) {
                ...
                for (var b, x = [], f = 0; c > f;)if (l.test(u[f])) {
                    ...
                    x.push({from: C, to: f, level: 0})
                } else {
                    var w = f, L = x.length;
                    for (++f; c > f && "L" != u[f]; ++f);
                    for (var g = w; f > g;)if (a.test(u[g])) {
                        g > w && x.splice(L, 0, {from: w, to: g, level: 1});
                        var k = g;
                        for (++g; f > g && a.test(u[g]); ++g);
                        x.splice(L, 0, {from: k, to: g, level: 2}), w = g
                    } else++g;
                    f > w && x.splice(L, 0, {from: w, to: f, level: 1})
                }
                return 1 == x[0].level && (b = t.match(/^\s+/)) && (x[0].from = b[0].length, x.unshift({
                    ...
                    to: c,
                    level: 0
                })), x[0].level != jn(x).level && x.push({from: c, to: c, level: x[0].level}), x
            }
        }();
    ...
    !function () {
        ...
        x.commands.newlineAndIndentContinueMarkdownList = function (r) {
            var n, i = r.getCursor(), o = r.getStateAfter(i.line).list;
            if (!o || !(n = r.getLine(i.line).match(e)))return r.execCommand("newlineAndIndent"), void 0;
            var l = n[1], a = n[4], s = t.indexOf(n[2]) >= 0 ? n[2] : parseInt(n[3], 10) + 1 + ".";
            r.replaceSelection("\n" + l + s + a, "end")
        }
        ...
        function c(e, t) {
            ...
            C.context = {prev: C.context, tagName: e, indent: C.indented, startOfLine: t, noIndent: r}
        }
        ...
        var b, x, C, w, L, k = e.indentUnit, S = t.multilineTagIndentFactor || 1, M = t.multilineTagIndentPastTag || !0, T = t.htmlMode ? {
            autoSelfClosers: {
                area: !0,
                base: !0,
                br: !0,
        ...
        return {
            startState: function () {
                return {tokenize: r, cc: [], indented: 0, startOfLine: !0, tagName: null, tagStart: null, context: null}
            },
            token: function (e, t) {
        ...
        function o(e, i) {
            ...
            if ("#" === e.peek() || i.prevLineHasContent && e.match(G))i.header = !0; else if (e.eat(">"))for (i.indentation++, i.quote = 1, e.eatSpace(); e.eat(">");)e.eatSpace(), i.quote++; else {
        ...
        function u(e, i) {
            ...
            if (i.taskList) {
                ...
                return a ? i.taskOpen = !0 : i.taskClosed = !0, i.taskList = !1, s(i)
            }
            ...
            if ("!" === c && e.match(/\[[^\]]*\] ?(?:\(|\[)/, !1))return e.match(/\[[^\]]*\]/), i.inline = i.f = f, H;
            if ("[" === c && e.match(/.*\](\(| ?\[)/, !1))return i.linkText = !0, s(i);
            if ("]" === c && i.linkText) {
                var v = s(i);
                return i.linkText = !1, i.inline = i.f = f, v
            }
            ...
            var d = s(i);
            if ("*" === c || "_" === c && !b) {
                if (i.strong === c && e.eat(c))return i.strong = !1, d;
                if (!i.strong && e.eat(c))return i.strong = c, s(i);
                if (i.em === c)return i.em = !1, d;
        ...
        function m(e, t, r) {
            return r = r || u, function (n, i) {
                return n.match(p(t)), i.inline = i.f = r, e
            }
        }

        var g = x.modes.hasOwnProperty("xml"), v = x.getMode(e, g ? {
            name: "xml",
            htmlMode: !0
        } : "text/plain"), y = {
            html: "htmlmixed",
            ...
            var a = [];
            for (var l in x.mimeModes)x.mimeModes.propertyIsEnumerable(l) && a.push({mime: l, mode: x.mimeModes[l]});
        ...
        var C = 0, w = "header", L = "comment", k = "atom", S = "number", M = "variable-2", T = "variable-3", N = "keyword", A = "hr", H = "tag", W = "link", D = "link", O = "link", E = "string", z = "em", I = "strong", F = /^([*\-=_])(?:\s*\1){2,}\s*$/, P = /^[*\-+]\s+/, B = /^[0-9]+\.\s+/, R = /^\[(x| )\](?=\s)/, G = /^(?:\={1,}|-{1,})$/, V = /^[^!\[\]*_\\<>` "'(]+/, _ = [];
        return {
            startState: function () {
                return {
                    f: o,
                ...
                if (e.sol()) {
                    ...
                    var r = e.match(/^\s*/, !0)[0].replace(/\t/g, "    ").length, n = 4 * Math.floor((r - t.indentation) / 4);
                    n > 4 && (n = 4);
    ...
    var C = /Mac/.test(navigator.platform), w = {
        "Cmd-B": l,
        "Cmd-I": a,
        "Cmd-K": f,
        "Cmd-Alt-I": h,
        ...
        "Cmd-Alt-L": u,
        "Cmd-L": c
    }, L = [{name: "bold", action: l}, {name: "italic", action: a}, "|", {
        name: "quote",
        action: s
    }, {name: "unordered-list", action: c}, {name: "ordered-list", action: u}, "|", {
        name: "link",
        action: f
    }, {name: "image", action: h}, "|", {
        name: "info",
        action: "http://lab.lepture.com/editor/markdown"
    }, {name: "preview", action: m}, {name: "fullscreen", action: o}];
    b.toolbar = L, b.markdown = function (e) {
        return window.markdowniter ? markdowniter.render(e) : void 0
        ...
        if (e || (e = this.element || document.getElementsByTagName("textarea")[0]), !this._rendered || this._rendered !== e) {
            ...
            i.Enter = "newlineAndIndentContinueMarkdownList", this.codemirror = x.fromTextArea(e, {
                ...
                lineNumbers: !1,
                extraKeys: i
            }), r.toolbar !== !1 && this.createToolbar(), r.status !== !1 && this.createStatusbar(), this._rendered = this.element
        }
        ...
        if (e = e || this.options.toolbar, e && 0 !== e.length) {
            ...
            for (var l = 0; l < e.length; l++)!function (e) {
                var i;
                i = e.name ? r(e.name, e) : "|" === e ? n() : r(e), e.action && ("function" == typeof e.action ? i.onclick = function () {
                    e.action(o)
...
!function (e, t) {
    var n, i = {}, r = function (e, t) {
        ...
        var s, o = {exports: t};
        "function" == typeof t && (n.length || (n = [r, o.exports, o]), s = t.apply(null, n), void 0 !== s && (o.exports = s)), i[e] = o.exports
    }, a = function (t) {
        var n = i[t] || e[t];
        ...
        for (t in i)if (n = e, i.hasOwnProperty(t)) {
            for (r = t.split("/"), o = a(r.pop()); s = a(r.shift());)n[s] = n[s] || {}, n = n[s];
            n[o] = i[t]
        }
        return e
    }, c = function (n) {
        return e.__dollar = n, u(t(e, s, r))
    };
    ...
    return t("dollar-third", [], function () {
        ...
        return {
            ...
            when: n.when,
            browser: function (e) {
                var t = {}, n = e.match(/WebKit\/([\d.]+)/), i = e.match(/Chrome\/([\d.]+)/) || e.match(/CriOS\/([\d.]+)/), r = e.match(/MSIE\s([\d\.]+)/) || e.match(/(?:trident)(?:.*rv:([\w.]+))?/i), s = e.match(/Firefox\/([\d.]+)/), o = e.match(/Safari\/([\d.]+)/), a = e.match(/OPR\/([\d.]+)/);
                return n && (t.webkit = parseFloat(n[1])), i && (t.chrome = parseFloat(i[1])), r && (t.ie = parseFloat(r[1])), s && (t.firefox = parseFloat(s[1])), o && (t.safari = parseFloat(o[1])), a && (t.opera = parseFloat(a[1])), t
            }(navigator.userAgent),
            os: function (e) {
                var t = {}, n = e.match(/(?:Android);?[\s\/]+([\d.]+)?/), i = e.match(/(?:iPad|iPod|iPhone).*OS\s([\d_]+)/);
            ...
            inherits: function (e, n, i) {
                ...
                }, t.extend(!0, r, e, i || {}), r.__super__ = e.prototype, r.prototype = s(e.prototype), n && t.extend(!0, r.prototype, n), r
            },
            noop: o,
            bindFn: r,
            log: function () {
        ...
        function n(e, t, n) {
            s.each((e || "").split(a), function (e, i) {
                n(i, t)
            })
        }

        function i(e, t) {
            for (var n, i = !1, r = -1, s = e.length; ++r < s;)if (n = e[r], n.cb.apply(n.ctx2, t) === !1) {
                i = !0;
                break
            }
            return !i
        ...
        var r, s = e.$, o = [].slice, a = /\s+/;
        return r = {
            on: function (e, t, i) {
                var r, s = this;
                return t ? (r = this._events || (this._events = []), n(e, t, function (e, t) {
                    var n = {e: e};
                    n.cb = t, n.ctx = i, n.ctx2 = i || s, n.id = r.length, r.push(n)
                }), this) : this
            }, once: function (e, t, i) {
                var r = this;
                ...
                var o = this._events;
                return o ? e || i || r ? (n(e, i, function (e, n) {
                    s.each(t(o, e, n, r), function () {
                        delete o[this.id]
                    })
        ...
        return n.options = {}, t.installTo(n.prototype), i.each({
            ...
            state: "pending", _init: function (e) {
                ...
                var n = [].slice.call(arguments, 1), r = this.options, s = "on" + e.substring(0, 1).toUpperCase() + e.substring(1);
        ...
        function n(t) {
            this.options = i.extend({container: document.body}, t), this.uid = e.guid("rt_")
        }

        var i = e.$, r = {}, s = function (e) {
        ...
        return i.extend(n.prototype, {
            ...
            }, init: e.noop, exec: e.noop, destroy: function () {
            ...
            if (t = t || n.orders, i.each(t.split(/\s*,\s*/g), function () {
                ...
                }), o = o || s(r), !o)throw alert("程序需要 Flash 11 以上版本才能正常运行，请前往：http://get.adobe.com/cn/flashplayer/ 安装"), new Error("Runtime Error");
            return a = new r[o](e)
        ...
        function i(t, i) {
            ...
            this.uid = e.guid("client_"), this.runtimeReady = function (e) {
                ...
                return o.done(a), "string" == typeof t && r.get(t) && (s = r.get(t)), s = s || r.get(null, i), s ? (e.$.extend(s.options, t), s.__promise.then(o.resolve), s.__client++) : (s = n.create(t, t.runtimeOrder), s.__promise = o.promise(), s.once("ready", o.resolve), s.init(), r.add(s), s.__client = 1), i && (s.__standalone = i), s
                ...
                if (s) {
                    ...
                    return t && n.unshift(t), s.exec.apply(this, n)
                }
        ...
        var r = e.$;
        return i.options = {accept: null, disableGlobalDnd: !1}, e.inherits(n, {
        ...
        var r = e.$, s = t.prototype._init, o = {}, a = [];
        return r.extend(i.prototype, {
            init: e.noop, invoke: function (e, t) {
            ...
            _init: function () {
                var e = this, t = e._widgets = [];
                return r.each(a, function (n, i) {
                    t.push(new i(e))
                }), s.apply(e, arguments)
            }, request: function (t, i, r) {
                var s, a, u, c, l = 0, d = this._widgets, p = d.length, h = [], f = [];
                for (i = n(i) ? i : [i]; p > l; l++)s = d[l], a = s.invoke(t, i), a !== o && (e.isPromise(a) ? f.push(a) : h.push(a));
                return r || f.length ? (u = e.when.apply(e, f), c = u.pipe ? "pipe" : "then", u[c](function () {
                    var t = e.Deferred(), n = arguments;
            ...
            var s, o = {init: "init"};
            return 1 === arguments.length ? (n = t, n.responseMap = o) : n.responseMap = r.extend(o, t), s = e.inherits(i, n), a.push(s), s
        }, i
        ...
        return t.options.dnd = "", t.register({
            init: function (t) {
                if (t.dnd && "html5" === this.request("predict-runtime-type")) {
                    var r, s = this, o = e.Deferred(), a = i.extend({}, {
                        disableGlobalDnd: t.disableGlobalDnd,
                        container: t.dnd,
                        accept: t.accept
                    });
                    return r = new n(a), r.once("ready", o.resolve), r.on("drop", function (e) {
        ...
        return t.register({
            init: function (t) {
                if (t.paste && "html5" === this.request("predict-runtime-type")) {
                    var r, s = this, o = e.Deferred(), a = i.extend({}, {container: t.paste, accept: t.accept});
                    return r = new n(a), r.once("ready", o.resolve), r.on("paste", function (e) {
        ...
        function n(e, n) {
            var i = this;
            i.source = n, i.ruid = e, this.size = n.size || 0, this.type = !n.type && ~"jpg,jpeg,png,gif,bmp".indexOf(this.ext) ? "image/" + ("jpg" === this.ext ? "jpeg" : this.ext) : n.type || "application/octet-stream", t.call(i, "Blob"), this.uid = n.uid || this.uid, e && i.connectRuntime(e)
        }

        return e.inherits(t, {
            constructor: n, slice: function (e, t) {
        ...
        function n(e, n) {
            var s;
            this.name = n.name || "untitled" + i++, s = r.exec(n.name) ? RegExp.$1.toLowerCase() : "", !s && n.type && (s = /\/(jpg|jpeg|png|gif|bmp)$/i.exec(n.type) ? RegExp.$1.toLowerCase() : "", this.name += "." + s), this.ext = s, this.lastModifiedDate = n.lastModifiedDate || (new Date).toLocaleString(), t.apply(this, arguments)
        }
        ...
        function r(e) {
            if (e = this.options = s.extend({}, r.options, e), e.container = s(e.id), !e.container.length)throw new Error("按钮指定错误");
            e.innerHTML = e.innerHTML || e.label || e.container.html() || "", e.button = s(e.button || document.createElement("div")), e.button.html(e.innerHTML), e.container.html(e.button), n.call(this, "FilePicker", !0)
        }
        ...
        return r.options = {
            ...
            constructor: r, init: function () {
                var t = this, n = t.options, r = n.button;
                r.addClass("webuploader-pick"), t.on("all", function (e) {
                    ...
                    switch (e) {
                        ...
                        case"mouseleave":
                            ...
                            break;
                        case"change":
                            o = t.exec("getFiles"), t.trigger("select", s.map(o, function (e) {
                ...
                var e = this.getRuntime().getContainer(), t = this.options.button, n = t.outerWidth ? t.outerWidth() : t.width(), i = t.outerHeight ? t.outerHeight() : t.height(), r = t.offset();
        ...
        var i = e.$;
        return i.extend(t.options, {pick: null, accept: null}), t.register({
            "add-btn": "addButton",
            refresh: "refresh",
            disable: "disable",
            enable: "enable"
            ...
            init: function (e) {
                ...
                var r = this, s = r.options, o = s.accept, a = [];
                if (t)return i.isPlainObject(t) || (t = {id: t}), i(t.id).each(function () {
                    var u, c, l;
        ...
        return r.extend(i.prototype, {
            append: function (e) {
                ...
                for (var e, t = [].slice.call(arguments, 0), n = [], i = 0, s = this._queue.length; s > i; i++)e = this._queue[i], (!t.length || ~r.inArray(e.getStatus(), t)) && n.push(e);
                return n
            }, _fileAdded: function (e) {
                var t = this, n = this._map[e.id];
    ...
    }), t("widgets/queue", ["base", "uploader", "queue", "file", "lib/file", "runtime/client", "widgets/widget"], function (e, t, n, i, r, s) {
        var o = e.$, a = /\.\w+$/, u = i.Status;
        return t.register({
            ...
            init: function (t) {
                ...
                if (o.isPlainObject(t.accept) && (t.accept = [t.accept]), t.accept) {
                    for (c = [], a = 0, r = t.accept.length; r > a; a++)u = t.accept[a].extensions, u && c.push(u);
                    c.length && (l = "\\." + c.join(",").replace(/,/g, "$|\\.").replace(/\*/g, ".*") + "$"), p.accept = new RegExp(l, "i")
                }
                return p.queue = new n, p.stats = p.queue.stats, "html5" === this.request("predict-runtime-type") ? (i = e.Deferred(), d = new s("Placeholder"), d.connectRuntime({runtimeOrder: "html5"}, function () {
                ...
                var t = this;
                return e = t._wrapFile(e), t.owner.trigger("beforeFileQueued", e) ? t.acceptFile(e) ? (t.queue.append(e), t.owner.trigger("fileQueued", e), e) : (t.owner.trigger("error", "Q_TYPE_DENIED", e), void 0) : void 0
            }, getFile: function (e) {
                ...
                var n, i, r, s = this;
                if (e)return e = e.id ? e : s.queue.getFile(e), e.setStatus(u.QUEUED), t || s.request("start-upload"), void 0;
                for (n = s.queue.getFiles(u.ERROR), i = 0, r = n.length; r > i; i++)e = n[i], e.setStatus(u.QUEUED);
        ...
        function r(e, t) {
            for (var n, i = [], r = e.source, s = r.size, o = t ? Math.ceil(s / t) : 1, a = 0, u = 0; o > u;)n = Math.min(t, s - a), i.push({
                file: e,
                start: a,
                end: t ? a + n : s,
                total: s,
        ...
        var s = e.$, o = e.isPromise, a = n.Status;
        s.extend(t.options, {
            prepareNextFile: !1,
            chunked: !1,
            chunkSize: 5242880,
            ...
            init: function () {
                ...
                this.runing = !1, this.pool = [], this.pending = [], this.remaning = 0, this.__tick = e.bindFn(this._tick, this), t.on("uploadComplete", function (e) {
                    e.blocks && s.each(e.blocks, function (e, t) {
                        t.transport && (t.transport.abort(), t.transport.destroy()), delete t.transport
                    }), delete e.blocks, delete e.remaning
                })
            }, start: function () {
                var t = this;
                s.each(t.request("get-files", a.INVALID), function () {
                    t.request("remove-file", this)
                }), t.runing || (t.runing = !0, s.each(t.pool, function (e, n) {
                    var i = n.file;
                ...
                var t = this;
                t.runing !== !1 && (t.runing = !1, e && s.each(t.pool, function (e, t) {
                ...
                e = this.request("get-file", e), e.setStatus(t || a.COMPLETE), e.skipped = !0, e.blocks && s.each(e.blocks, function (e, t) {
                    var n = t.transport;
                ...
                var e, t, n = this, i = n._act, s = n.options;
                ...
                var n, r, o = this, u = o.owner, c = o.options, l = t.file, d = new i(c), p = s.extend({}, c.formData), h = s.extend({}, c.headers);
                t.transport = d, d.on("destroy", function () {
                    delete t.transport, o._popBlock(t), e.nextTick(o.__tick)
                }), d.on("progress", function (e) {
                    var n = 0, i = 0;
                    n = t.percentage = e, t.chunks > 1 && (s.each(l.blocks, function (e, t) {
                    ...
                    chunks: t.chunks,
                    chunk: t.chunk
                }), u.trigger("uploadBeforeSend", t, p, h), d.appendBlob(c.fileVal, t.blob, l.name), d.append(p), d.setRequestHeader(h), d.send()
        ...
        return i = {
            ...
            var e = this, t = e.options, n = 0, i = t.fileSizeLimit >> 0, r = !0;
            i && (e.on("beforeFileQueued", function (e) {
                var t = n + e.size > i;
            ...
            var e = this, t = e.options, i = t.fileSingleSizeLimit;
            i && e.on("beforeFileQueued", function (e) {
        ...
        function r() {
            var e = {}, i = this, r = this.destory;
            n.apply(i, arguments), i.type = s, i.exec = function (n, r) {
                var s, a = this, u = a.uid, c = t.slice(arguments, 2);
        ...
        return t.register("DragAndDrop", {
            init: function () {
                ...
                var t, s, o = this, a = o.getRuid(), u = o.elem.parent().get(0);
                ...
                return s ? void 0 : (o._getTansferFiles(t, function (e) {
                    o.trigger("drop", i.map(e, function (e) {
                        return new n(a, e)
                    }))
                }), o.dndOver = !1, o.elem.removeClass(r + "over"), !1)
            }, _getTansferFiles: function (t, n) {
                var i, r, s, o, a, u, c, l = [], d = [];
                for (i = t.items, r = t.files, c = !(!i || !i[0].webkitGetAsEntry), a = 0, u = r.length; u > a; a++)s = r[a], o = i && i[a], c && o.webkitGetAsEntry().isDirectory ? d.push(this._traverseDirectoryTree(o.webkitGetAsEntry(), l)) : l.push(s);
                e.when.apply(e, d).done(function () {
                    l.length && n(l)
                })
            }, _traverseDirectoryTree: function (t, n) {
                var i = e.Deferred(), r = this;
                return t.isFile ? t.file(function (e) {
                    n.push(e), i.resolve()
                }) : t.isDirectory && t.createReader().readEntries(function (t) {
                    var s, o = t.length, a = [], u = [];
        ...
        return t.register("FilePaste", {
            init: function () {
                var t, n, i, r, s = this.options, o = this.elem = s.container, a = ".*";
                if (s.accept) {
                    for (t = [], n = 0, i = s.accept.length; i > n; n++)r = s.accept[n].mimeTypes, r && t.push(r);
                    t.length && (a = t.join(","), a = a.replace(/,/g, "|").replace(/\*/g, ".*"))
                }
                this.accept = a = new RegExp(a, "i"), this.hander = e.bindFn(this._pasteHander, this), o.on("paste", this.hander)
            }, _pasteHander: function (e) {
                var t, i, r, s, o, a = [], u = this.getRuid();
                for (e = e.originalEvent || e, t = e.clipboardData.items, s = 0, o = t.length; o > s; s++)i = t[s], "file" === i.kind && (r = i.getAsFile()) && a.push(new n(u, r));
        ...
        return t.register("FilePicker", {
            init: function () {
                var e, t, i, r, s = this.getRuntime().getContainer(), o = this, a = o.owner, u = o.options, c = n(document.createElement("label")), l = n(document.createElement("input"));
                ...
                s.append(l), s.append(c), r = function (e) {
                    a.trigger(e.type)
                }, l.on("change", function (e) {
                    var t, i = arguments.callee;
                    o.files = e.target.files, t = this.cloneNode(!0), t.value = null, this.parentNode.replaceChild(t, this), l.off(), l = n(t).on("change", i).on("mouseenter mouseleave", r), a.trigger("change")
        ...
        return t.register("Transport", {
            init: function () {
                ...
                var t, n, r, s = this.owner, o = this.options, a = this._initAjax(), u = s._blob, c = o.server;
                o.sendAsBinary ? (c += (/\?/.test(c) ? "&" : "?") + i.param(s._formData), n = u.getSource()) : (t = new FormData, i.each(s._formData, function (e, n) {
                    t.append(e, n)
                }), t.append(o.fileVal, u.getSource(), o.filename || s._formData.name || "")), o.withCredentials && "withCredentials"in a ? (a.open(o.method, c, !0), a.withCredentials = !0) : a.open(o.method, c), this._setRequestHeader(a, o.headers), n ? (a.overrideMimeType("application/octet-stream"), e.os.android ? (r = new FileReader, r.onload = function () {
                ...
                var e = this, t = new XMLHttpRequest, i = this.options;
        ...
        function s() {
            function i(e, t) {
                var n, i, r = e.type || e;
                n = r.split("::"), i = n[0], r = n[1], "Ready" === r && i === c.uid ? c.trigger("ready") : s[i] && s[i].trigger(r.toLowerCase(), e, t)
            }

            var r = {}, s = {}, o = this.destory, c = this, l = t.guid("webuploader_");
            n.apply(c, arguments), c.type = a, c.exec = function (e, n) {
                var i, o = this, a = o.uid, l = t.slice(arguments, 2);
                return s[a] = o, u[e] && (r[a] || (r[a] = new u[e](o, c)), i = r[a], i[n]) ? i[n].apply(i, l) : c.flashExec.apply(o, arguments)
            }, e[l] = function () {
                var e = arguments;
                setTimeout(function () {
                    i.apply(null, e)
                ...
                var i = c.getFlash(), r = t.slice(arguments, 2);
        ...
        return t.register("Transport", {
            init: function () {
                ...
                var e, t = this.owner, n = this.options, r = this._initAjax(), s = t._blob, o = n.server;
                r.connectRuntime(s.ruid), n.sendAsBinary ? (o += (/\?/.test(o) ? "&" : "?") + i.param(t._formData), e = s.uid) : (i.each(t._formData, function (e, t) {
                    r.exec("append", e, t)
                }), r.exec("appendBlob", n.fileVal, s.uid, n.filename || t._formData.name || "")), this._setRequestHeader(r, n.headers), r.exec("send", {
                    method: n.method,
                    url: o,
                ...
                return t.on("uploadprogress progress", function (t) {
                    ...
                    var n = t.exec("getStatus"), i = "";
                    return t.off(), e._xhr = null, n >= 200 && 300 > n ? (e._response = t.exec("getResponse"), e._responseJson = t.exec("getResponseAsJson")) : n >= 500 && 600 > n ? (e._response = t.exec("getResponse"), e._responseJson = t.exec("getResponseAsJson"), i = "server") : i = "http", e._response = decodeURIComponent(e._response), t.destroy(), t = null, i ? e.trigger("error", i) : e.trigger("load")
                }), t.on("error", function () {
...
!function (i, o, e) {
    ...
    t.set({
        ...
        linkify: !1,
        typographer: !1
    }), window.markdowniter = t;
    var a = i.toolbar, r = function (i, o) {
        ...
        this.$win = $(['<div class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="editorToolImageTitle" aria-hidden="true">', '<div class="modal-header">', '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>', '<h3 id="editorToolImageTitle">添加连接</h3>', "</div>", '<div class="modal-body">', '<form class="form-horizontal">', '<div class="control-group">', '<label class="control-label">标题</label>', '<div class="controls">', '<input type="text" name="title" placeholder="Title">', "</div>", "</div>", '<div class="control-group">', '<label class="control-label">连接</label>', '<div class="controls">', '<input type="text" name="link" value="http://" placeholder="Link">', "</div>", "</div>", "</form>", "</div>", '<div class="modal-footer">', '<button class="btn btn-primary" role="save">确定</button>', "</div>", "</div>"].join("")).appendTo(l), this.$win.on("click", "[role=save]", function () {
            ...
            var o = $(this), e = o.find("[name=title]").val(), t = o.find("[name=link]").val();
            return i.$win.modal("hide"), i.editor.push(" [" + e + "](" + t + ")"), o.find("[name=title]").val(""), o.find("[name=link]").val("http://"), !1
        })
    };
    ...
    var n = function () {
        ...
        }), this.uploader.on("beforeFileQueued", function (o) {
            return i.file === !1 && i.editor ? (i.showFile(o), void 0) : !1
        }), this.uploader.on("uploadProgress", function (o, e) {
            i.showProgress(o, 100 * e)
        }), this.uploader.on("uploadSuccess", function (o, e) {
            e.success ? (i.$win.modal("hide"), i.editor.push("![" + o.name + "](" + e.url + ")")) : (i.removeFile(), i.showError(e.msg || "服务器走神了，上传失败"))
        }), this.uploader.on("uploadComplete", function (o) {
            i.uploader.removeFile(o), i.removeFile()
        }), this.uploader.on("error", function (o) {
    ...
    i.prototype.createToolbar = function (i) {
        p.call(this, i);
        var o = this;
        $(o.codemirror.display.input).on("focus", function () {
            s.editor = o
        })
    }, i.prototype.push = function (i) {
        var o = this.codemirror, e = o.lastLine();
